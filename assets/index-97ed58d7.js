...
const Wa = new Be().set(
  ...
  $i = {
    ...
    [Ir]: {
      transfer: wr,
      primaries: Cr,
      toReference: (r) => r.applyMatrix3(Xa),
      fromReference: (r) => r.applyMatrix3(Wa),
    },
    [zs]: {
      transfer: $e,
      primaries: Cr,
      toReference: (r) => r.convertSRGBToLinear().applyMatrix3(Xa),
      fromReference: (r) => r.applyMatrix3(Wa).convertLinearToSRGB(),
    },
  },
  hu = new Set([gt, Ir]),
  Xe = {
    ...
    getPrimaries: function (r) {
      return $i[r].primaries;
    },
    getTransfer: function (r) {
      return r === Nt ? wr : $i[r].transfer;
    },
  };
function di(r) {
  return r < 0.04045
  ...
  static sRGBToLinear(e) {
    if (
      ...
      const i = n.getImageData(0, 0, e.width, e.height),
        s = i.data;
      for (let a = 0; a < s.length; a++) s[a] = di(s[a] / 255) * 255;
...
class mt extends kn {
  ...
  get encoding() {
    return (
      ...
      this.colorSpace === et ? Fn : gc
    );
  }
  set encoding(e) {
    Gi("THREE.Texture: Property .encoding has been replaced by .colorSpace."),
      (this.colorSpace = e === Fn ? et : Nt);
  }
}
mt.DEFAULT_IMAGE = null;
mt.DEFAULT_MAPPING = oc;
      ...
      return (
        v > y && v > b
          ? v < 0.01
            ...
            : ((n = Math.sqrt(v)), (i = L / n), (s = A / n))
          : y > b
          ? y < 0.01
            ? ((n = 0.707106781), (i = 0), (s = 0.707106781))
            : ((i = Math.sqrt(y)), (n = L / i), (s = G / i))
          : b < 0.01
          ? ((n = 0.707106781), (i = 0.707106781), (s = 0))
          : ((s = Math.sqrt(b)), (n = A / s), (i = G / s)),
        this.set(n, i, s, t),
        this
      );
    }
...
class pu extends kn {
  constructor(e = 1, t = 1, n = {}) {
    ...
    n.encoding !== void 0 &&
      ...
      (n.colorSpace = n.encoding === Fn ? et : Nt)),
      (n = Object.assign(
        {
          generateMipmaps: !1,
          internalFormat: null,
...
class P {
  ...
  applyQuaternion(e) {
    const t = this.x,
      ...
      d = -s * t - a * n - o * i;
    return (
      (this.x = l * c + d * -s + u * -o - h * -a),
      (this.y = u * c + d * -a + h * -s - l * -o),
      (this.z = h * c + d * -o + l * -a - u * -s),
      this
    );
  }
  project(e) {
...
class un {
      ...
      if (i !== void 0)
        if (t && i.attributes !== void 0 && i.attributes.position !== void 0) {
          ...
          for (let a = 0, o = s.count; a < o; a++)
            Qt.fromBufferAttribute(s, a).applyMatrix4(e.matrixWorld),
  ...
  intersectsTriangle(e) {
    ...
    return !Qr(t, jn, Yn, Kn, Ji) ||
      ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !Qr(t, jn, Yn, Kn, Ji))
      ? !1
      : (Qi.crossVectors(hn, dn),
        (t = [Qi.x, Qi.y, Qi.z]),
        Qr(t, jn, Yn, Kn, Ji));
  }
  clampPoint(e, t) {
    ...
    return e.isEmpty()
      ...
      : (this.center.equals(e.center) === !0
          ...
          : (es.subVectors(e.center, this.center).setLength(e.radius),
            this.expandByPoint(Pi.copy(e.center).add(es)),
            this.expandByPoint(Pi.copy(e.center).sub(es))),
        this);
  }
  equals(e) {
...
class Xi {
  ...
  distanceSqToSegment(e, t, n, i) {
    ts.copy(e).add(t).multiplyScalar(0.5),
      er.copy(t).sub(e).normalize(),
      fn.copy(this.origin).sub(ts);
    const s = e.distanceTo(t) * 0.5,
      a = -this.direction.dot(er),
    ...
    return (
      ...
      i && i.copy(ts).addScaledVector(er, d),
      m
    );
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, n, i, s) {
    ...
    const c = o * this.direction.dot(tr.crossVectors(fn, tr));
    if (c < 0) return null;
    const l = o * this.direction.dot(ns.cross(fn));
...
class He {
  ...
  multiplyMatrices(e, t) {
    const n = e.elements,
      ...
      I = i[15];
    return (
      (s[0] = a * L + o * w + c * D + l * ie),
      (s[4] = a * A + o * W + c * k + l * K),
      (s[8] = a * G + o * Z + c * q + l * j),
      (s[12] = a * M + o * J + c * V + l * I),
      (s[1] = u * L + h * w + d * D + m * ie),
      (s[5] = u * A + h * W + d * k + m * K),
      (s[9] = u * G + h * Z + d * q + m * j),
      (s[13] = u * M + h * J + d * V + m * I),
      (s[2] = g * L + _ * w + p * D + f * ie),
      (s[6] = g * A + _ * W + p * k + f * K),
      (s[10] = g * G + _ * Z + p * q + f * j),
      (s[14] = g * M + _ * J + p * V + f * I),
      (s[3] = T * L + v * w + y * D + b * ie),
      (s[7] = T * A + v * W + y * k + b * K),
      (s[11] = T * G + v * Z + y * q + b * j),
      (s[15] = T * M + v * J + y * V + b * I),
      this
    );
  }
  multiplyScalar(e) {
  ...
  invert() {
    const e = this.elements,
      ...
      p = e[14],
      f = e[15],
      T = h * p * l - _ * d * l + _ * c * m - o * p * m - h * c * f + o * d * f,
      v = g * d * l - u * p * l - g * c * m + a * p * m + u * c * f - a * d * f,
      y = u * _ * l - g * h * l + g * o * m - a * _ * m - u * o * f + a * h * f,
      b = g * h * c - u * _ * c - g * o * d + a * _ * d + u * o * p - a * h * p,
      L = t * T + n * v + i * y + s * b;
    if (L === 0)
  ...
  makePerspective(e, t, n, i, s, a, o = cn) {
    const c = this.elements,
      ...
      d = (n + i) / (n - i);
    let m, g;
    if (o === cn) (m = -(a + s) / (a - s)), (g = (-2 * a * s) / (a - s));
    else if (o === Lr) (m = -a / (a - s)), (g = (-a * s) / (a - s));
    else
      throw new Error(
  ...
  makeOrthographic(e, t, n, i, s, a, o = cn) {
    const c = this.elements,
      l = 1 / (t - e),
      u = 1 / (n - i),
      h = 1 / (a - s),
      ...
      m = (n + i) * u;
    let g, _;
    if (o === cn) (g = (a + s) * h), (_ = -2 * h);
    else if (o === Lr) (g = s * h), (_ = -1 * h);
    else
      throw new Error(
...
const Zn = new P(),
  ...
  Ya = new Yt();
class Ur {
  constructor(e = 0, t = 0, n = 0, i = Ur.DEFAULT_ORDER) {
    (this.isEuler = !0),
      (this._x = e),
      (this._y = t),
      (this._z = n),
...
class Je extends kn {
  ...
  lookAt(e, t, n) {
    ...
    this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? tn.lookAt(Di, ir, this.up)
        : tn.lookAt(ir, Di, this.up),
      this.quaternion.setFromRotationMatrix(tn),
      i &&
        (tn.extractRotation(i.matrixWorld),
        $n.setFromRotationMatrix(tn),
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Di, e, Mu), e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Di, Su, e), e
    );
  }
  getWorldDirection(e) {
    this.updateWorldMatrix(!0, !1);
...
class Ht {
  ...
  static getBarycoord(e, t, n, i, s) {
    Bt.subVectors(i, t), nn.subVectors(n, t), rs.subVectors(e, t);
    const a = Bt.dot(Bt),
      o = Bt.dot(nn),
      c = Bt.dot(rs),
      l = nn.dot(nn),
  ...
  static getUV(e, t, n, i, s, a, o, c) {
    return (
      rr === !1 &&
        ...
        (rr = !0)),
      this.getInterpolation(e, t, n, i, s, a, o, c)
    );
  }
  ...
  closestPointToPoint(e, t) {
    const n = this.a,
      ...
      s = this.c;
    let a, o;
    Jn.subVectors(i, n), Qn.subVectors(s, n), ss.subVectors(e, n);
    const c = Jn.dot(ss),
      l = Qn.dot(ss);
...
class jt extends kn {
  constructor() {
    super(),
      ...
      (this.stencilFail = Yr),
      (this.stencilZFail = Yr),
      (this.stencilZPass = Yr),
      (this.stencilWrite = !1),
...
class Ie {
  ...
  setHSL(e, t, n, i = Xe.workingColorSpace) {
    if (((e = Gs(e, 1)), (t = pt(t, 0, 1)), (n = pt(n, 0, 1)), t === 0))
...
class Tt {
  ...
  toJSON() {
    ...
    return (
      ...
      this.usage !== Ls && (e.usage = this.usage),
  ...
  computeTangents() {
    ...
    for (let w = 0, W = y.length; w < W; ++w) {
      const Z = y[w],
        J = Z.start,
        D = Z.count;
      for (let k = J, q = J + D; k < q; k += 3) v(n[k + 0], n[k + 1], n[k + 2]);
    }
    const b = new P(),
      L = new P(),
      A = new P(),
      G = new P();
    function M(w) {
      A.fromArray(s, w * 3), G.copy(A);
      const W = l[w];
      b.copy(W),
        b.sub(A.multiplyScalar(A.dot(W))).normalize(),
        L.crossVectors(G, W);
...
class Ot extends Je {
    ...
    if (s && o) {
      ...
      for (let c = 0, l = s.length; c < l; c++) {
        const u = o[c],
          h = s[c];
        u !== 0 &&
          (us.fromBufferAttribute(h, e),
          a ? cr.addScaledVector(us, u) : cr.addScaledVector(us.sub(t), u));
      }
      t.add(cr);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    i !== void 0 &&
      ...
      !(
        or.containsPoint(Rn.origin) === !1 &&
        (Rn.intersectSphere(or, to) === null ||
          Rn.origin.distanceToSquared(to) > (e.far - e.near) ** 2)
      ) &&
        (eo.copy(s).invert(),
        Rn.copy(e.ray).applyMatrix4(eo),
    ...
    if (o !== null)
      if (Array.isArray(a))
        for (let g = 0, _ = d.length; g < _; g++) {
          ...
          for (let y = T, b = v; y < b; y += 3) {
            const L = o.getX(y),
              A = o.getX(y + 1),
              G = o.getX(y + 2);
            (i = pr(this, f, e, n, l, u, h, L, A, G)),
              i &&
...
function bu(r, e, t, n, i, s, a, o) {
  let c;
  if (
    (e.side === bt
      ? (c = n.intersectTriangle(a, s, i, !0, o))
      : (c = n.intersectTriangle(i, s, a, e.side === ln, o)),
    c === null)
  )
    return null;
  ...
  return l < t.near || l > t.far
    ? null
    : { distance: l, point: fr.clone(), object: r };
}
function pr(r, e, t, n, i, s, a, o, c, l) {
  r.getVertexPosition(o, ti),
    r.getVertexPosition(c, ni),
    r.getVertexPosition(l, ii);
  const u = bu(r, e, t, n, ti, ni, ii, dr);
  if (u) {
    i &&
      (lr.fromBufferAttribute(i, o),
      ur.fromBufferAttribute(i, c),
      hr.fromBufferAttribute(i, l),
      (u.uv = Ht.getInterpolation(dr, ti, ni, ii, lr, ur, hr, new Ce()))),
      s &&
        (lr.fromBufferAttribute(s, o),
        ur.fromBufferAttribute(s, c),
        hr.fromBufferAttribute(s, l),
        (u.uv1 = Ht.getInterpolation(dr, ti, ni, ii, lr, ur, hr, new Ce())),
        (u.uv2 = u.uv1)),
      a &&
        (no.fromBufferAttribute(a, o),
        io.fromBufferAttribute(a, c),
        ro.fromBufferAttribute(a, l),
        (u.normal = Ht.getInterpolation(dr, ti, ni, ii, no, io, ro, new P())),
...
class qi extends kt {
  constructor(e = 1, t = 1, n = 1, i = 1, s = 1, a = 1) {
    ...
    g("z", "y", "x", -1, -1, n, t, e, a, s, 0),
      ...
      this.setAttribute("uv", new Gt(h, 2));
    function g(_, p, f, T, v, y, b, L, A, G, M) {
      const w = y / A,
        W = b / G,
        Z = y / 2,
        J = b / 2,
      ...
      for (let j = 0; j < G; j++)
        for (let I = 0; I < A; I++) {
          const B = d + I + k * j,
            ...
            he = d + (I + 1) + k * (j + 1),
            de = d + (I + 1) + k * j;
          c.push(B, le, de), c.push(le, he, de), (ie += 6);
        }
      o.addGroup(m, ie, M), (m += ie), (d += V);
    }
  }
  copy(e) {
    return (
...
class Pu extends Je {
  constructor(e, t, n) {
    ...
    const i = new Et(ri, si, e, t);
    (i.layers = this.layers), this.add(i);
    const s = new Et(ri, si, e, t);
    (s.layers = this.layers), this.add(s);
    const a = new Et(ri, si, e, t);
    (a.layers = this.layers), this.add(a);
    const o = new Et(ri, si, e, t);
    (o.layers = this.layers), this.add(o);
    const c = new Et(ri, si, e, t);
    (c.layers = this.layers), this.add(c);
    const l = new Et(ri, si, e, t);
...
class Du extends Hn {
  constructor(e = 1, t = {}) {
    ...
    t.encoding !== void 0 &&
      ...
      (t.colorSpace = t.encoding === Fn ? et : Nt)),
      (this.texture = new Lc(
        i,
        t.mapping,
        t.wrapS,
...
class _n {
  ...
  setFromCoplanarPoints(e, t, n) {
    const i = hs.subVectors(n, t).cross(Iu.subVectors(e, t)).normalize();
...
class ks {
  ...
  setFromProjectionMatrix(e, t = cn) {
    const n = this.planes,
      ...
      y = i[15];
    if (
      (n[0].setComponents(c - s, d - l, p - m, y - f).normalize(),
      n[1].setComponents(c + s, d + l, p + m, y + f).normalize(),
      n[2].setComponents(c + a, d + u, p + g, y + T).normalize(),
      n[3].setComponents(c - a, d - u, p - g, y - T).normalize(),
      n[4].setComponents(c - o, d - h, p - _, y - v).normalize(),
      t === cn)
    )
      n[5].setComponents(c + o, d + h, p + _, y + v).normalize();
    else if (t === Lr) n[5].setComponents(o, h, _, v).normalize();
    else
      throw new Error(
...
class Vs extends kt {
  constructor(e = 1, t = 1, n = 1, i = 1) {
    ...
    for (let f = 0; f < u; f++) {
      ...
      for (let v = 0; v < l; v++) {
        const y = v * h - s;
        g.push(y, -T, 0), _.push(0, 0, 1), p.push(v / o), p.push(1 - f / c);
      }
    }
    for (let f = 0; f < c; f++)
      for (let T = 0; T < o; T++) {
...
#endif`,
  uh = "gl_FragColor = linearToOutputTexel( gl_FragColor );",
  hh = `
...
IncidentLight directLight;
...
#endif`,
  Vh = `#if defined( USE_MAP ) || defined( USE_ALPHAMAP )
...
#endif`,
  jh = `#if defined( USE_MORPHCOLORS ) && defined( MORPHTARGETS_TEXTURE )
  ...
  Zh = `#ifdef USE_MORPHTARGETS
	...
	#endif
#endif`,
  $h = `float faceDirection = gl_FrontFacing ? 1.0 : - 1.0;
#ifdef FLAT_SHADED
...
#endif`,
  ud = `vec4 mvPosition = vec4( transformed, 1.0 );
#ifdef USE_INSTANCING
...
void main() {
  ...
  Oe = {
    ...
    morphtarget_pars_vertex: Kh,
    morphtarget_vertex: Zh,
    normal_fragment_begin: $h,
  ...
  Wt = {
    ...
    depth: {
      uniforms: yt([oe.common, oe.displacementmap]),
...
function pf(r, e, t, n, i, s, a) {
  ...
  function g(p, f) {
    ...
    v && v.isTexture && (v = (f.backgroundBlurriness > 0 ? t : e).get(v)),
      v === null ? _(o, c) : v && v.isColor && (_(v, 1), (T = !0));
    ...
    y === "additive"
      ...
      v && (v.isCubeTexture || v.mapping === Dr)
        ? (u === void 0 &&
            ((u = new Ot(
              new qi(1, 1, 1),
              new zn({
                name: "BackgroundCubeMaterial",
                uniforms: Mi(Wt.backgroundCube.uniforms),
            ...
            (u.onBeforeRender = function (b, L, A) {
          ...
          (u.material.toneMapped = Xe.getTransfer(v.colorSpace) !== $e),
        ...
        : v &&
          ...
          (l === void 0 &&
            ((l = new Ot(
              ...
              new zn({
                ...
                uniforms: Mi(Wt.background.uniforms),
          ...
          (l.material.uniforms.backgroundIntensity.value =
            f.backgroundIntensity),
          (l.material.toneMapped = Xe.getTransfer(v.colorSpace) !== $e),
  ...
  function _(p, f) {
    p.getRGB(gr, Rc(r)), n.buffers.color.setClear(gr.r, gr.g, gr.b, f, a);
  }
  return {
...
function mf(r, e, t, n) {
  ...
  function h(D, k, q, V, ie) {
    ...
    if (a) {
      ...
      (l.geometry !== V.id || l.program !== q.id || l.wireframe !== j) &&
        ((l.geometry = V.id), (l.program = q.id), (l.wireframe = j), (K = !0));
    }
    ie !== null && t.update(ie, r.ELEMENT_ARRAY_BUFFER),
      (K || u) &&
        ((u = !1),
        G(D, k, q, V),
        ie !== null && r.bindBuffer(r.ELEMENT_ARRAY_BUFFER, t.get(ie).buffer));
  }
  function d() {
  ...
  function _(D, k, q) {
    ...
    let ie = o[D.id];
    ie === void 0 && ((ie = {}), (o[D.id] = ie));
    let K = ie[k.id];
    K === void 0 && ((K = {}), (ie[k.id] = K));
    let j = K[V];
    return j === void 0 && ((j = p(d())), (K[V] = j)), j;
  }
  function p(D) {
    const k = [],
      q = [],
      V = [];
    for (let ie = 0; ie < i; ie++) (k[ie] = 0), (q[ie] = 0), (V[ie] = 0);
    return {
      geometry: null,
      program: null,
      wireframe: !1,
        ...
        if (
          (de === void 0 &&
            (B === "instanceMatrix" &&
              D.instanceMatrix &&
              (de = D.instanceMatrix),
            B === "instanceColor" && D.instanceColor && (de = D.instanceColor)),
          he === void 0 || he.attribute !== de || (de && he.data !== de.data))
        )
          return !0;
        j++;
      }
    return l.attributesNum !== j || l.index !== V;
  }
  function T(D, k, q, V) {
    const ie = {},
      K = k.attributes;
      ...
      if (I[B].location >= 0) {
        ...
        he === void 0 &&
          (B === "instanceMatrix" &&
            D.instanceMatrix &&
            (he = D.instanceMatrix),
          B === "instanceColor" && D.instanceColor && (he = D.instanceColor));
        const de = {};
        (de.attribute = he),
    ...
    (l.attributes = ie), (l.attributesNum = j), (l.index = V);
  }
  function v() {
    const D = l.newAttributes;
    for (let k = 0, q = D.length; k < q; k++) D[k] = 0;
  }
  function y(D) {
    b(D, 0);
  }
  function b(D, k) {
    const q = l.newAttributes,
      ...
      ie = l.attributeDivisors;
    (q[D] = 1),
      V[D] === 0 && (r.enableVertexAttribArray(D), (V[D] = 1)),
      ie[D] !== k &&
  ...
  function L() {
    ...
    for (let q = 0, V = k.length; q < V; q++)
      k[q] !== D[q] && (r.disableVertexAttribArray(q), (k[q] = 0));
  }
  function A(D, k, q, V, ie, K, j) {
    j === !0
      ? r.vertexAttribIPointer(D, k, q, ie, K)
      : r.vertexAttribPointer(D, k, q, V, ie, K);
  }
  function G(D, k, q, V) {
    if (
      n.isWebGL2 === !1 &&
    ...
    for (const I in K) {
      ...
      if (B.location >= 0) {
        ...
        if (
          ...
          const Le = ye.buffer,
            ve = ye.type,
            Ve = ye.bytesPerElement,
            ft =
              n.isWebGL2 === !0 &&
              (ve === r.INT || ve === r.UNSIGNED_INT || le.gpuType === lc);
          if (le.isInterleavedBufferAttribute) {
            ...
            if (Ue.isInstancedInterleavedBuffer) {
              ...
              for (let Me = 0; Me < B.locationSize; Me++) y(B.location + Me);
            r.bindBuffer(r.ARRAY_BUFFER, Le);
            for (let Me = 0; Me < B.locationSize; Me++)
              A(
                B.location + Me,
                de / B.locationSize,
          ...
          if (he !== void 0)
            switch (he.length) {
              case 2:
                r.vertexAttrib2fv(B.location, he);
                break;
              case 3:
                r.vertexAttrib3fv(B.location, he);
                break;
              case 4:
                r.vertexAttrib4fv(B.location, he);
                break;
              default:
                r.vertexAttrib1fv(B.location, he);
            }
        }
      }
    }
  ...
  function M() {
    ...
    for (const D in o) {
      ...
      for (const q in k) {
        const V = k[q];
        for (const ie in V) g(V[ie].object), delete V[ie];
        delete k[q];
      }
      delete o[D];
    }
...
function _f(r, e, t) {
  ...
  const l = a || e.has("WEBGL_draw_buffers"),
    ...
    b = v && y,
    L = a ? r.getParameter(r.MAX_SAMPLES) : 0;
  return {
    isWebGL2: a,
    drawBuffers: l,
    getMaxAnisotropy: i,
...
function vf(r) {
  let e = new WeakMap();
  function t(a, o) {
    return o === bs ? (a.mapping = pi) : o === ws && (a.mapping = mi), a;
  }
  function n(a) {
...
class co {
  ...
  _sceneToCubeUV(e, t, n, i) {
    const o = new Et(90, 1, t, n),
      ...
      h = u.autoClear,
      d = u.toneMapping;
    u.getClearColor(ao), (u.toneMapping = Sn), (u.autoClear = !1);
    const m = new In({
  ...
  _halfBlur(e, t, n, i, s, a, o) {
    ...
    const u = 3,
      ...
      g = isFinite(s) ? Math.PI / (2 * m) : (2 * Math.PI) / (2 * Dn - 1),
      _ = s / g,
      p = isFinite(s) ? 1 + Math.floor(u * _) : Dn;
    p > Dn &&
      console.warn(
    ...
    const y = this._sizeLods[i],
      b = 3 * y * (i > v - ui ? i - v + ui : 0),
      L = 4 * (this._cubeSize - y);
    _r(t, b, L, 3 * y, 2 * y), c.setRenderTarget(t), c.render(h, ds);
  }
}
function Mf(r) {
  const e = [],
    ...
    n = [];
  let i = r;
  const s = r - ui + 1 + so.length;
  for (let a = 0; a < s; a++) {
    const o = Math.pow(2, i);
    t.push(o);
    let c = 1 / o;
    a > r - ui ? (c = so[a - r + ui - 1]) : a === 0 && (c = 0), n.push(c);
    const l = 1 / (o - 2),
      u = -l,
      h = 1 + l,
    ...
    for (let L = 0; L < m; L++) {
      ...
      T.set(M, _ * g * L), v.set(d, p * g * L);
      const w = [L, L, L, L, L, L];
      y.set(w, f * g * L);
    }
    const b = new kt();
    b.setAttribute("position", new Tt(T, _)),
      b.setAttribute("uv", new Tt(v, p)),
      b.setAttribute("faceIndex", new Tt(y, f)),
      e.push(b),
      i > ui && i--;
  }
...
function Tf(r, e, t, n) {
  ...
  function l(h) {
    ...
    if (m !== null) {
      const T = m.array;
      _ = m.version;
      for (let v = 0, y = T.length; v < y; v += 3) {
        const b = T[v + 0],
          L = T[v + 1],
          A = T[v + 2];
        d.push(b, L, L, A, A, b);
      ...
      const T = g.array;
      _ = g.version;
      for (let v = 0, y = T.length / 3 - 1; v < y; v += 3) {
        const b = v + 0,
          L = v + 1,
          A = v + 2;
        d.push(b, L, L, A, A, b);
...
function Af(r, e, t, n) {
  ...
  function h(d, m, g) {
    if (g === 0) return;
    let _, p;
    if (i) (_ = r), (p = "drawElementsInstanced");
    else if (
  ...
  function c(l, u, h) {
    ...
    if (e.isWebGL2 === !0) {
      ...
      if (p === void 0 || p.count !== _) {
        ...
        let w = u.attributes.position.count * M,
          W = 1;
        w > e.maxTextureSize &&
          ((W = Math.ceil(w / e.maxTextureSize)), (w = e.maxTextureSize));
        const Z = new Float32Array(w * W * 4 * _),
          J = new Ec(Z, w, W, _);
        ...
        for (let q = 0; q < _; q++) {
          ...
          for (let I = 0; I < V.count; I++) {
            const B = I * D;
            v === !0 &&
              (a.fromBufferAttribute(V, I),
              (Z[j + B + 0] = a.x),
              (Z[j + B + 1] = a.y),
              (Z[j + B + 2] = a.z),
              (Z[j + B + 3] = 0)),
              y === !0 &&
                (a.fromBufferAttribute(ie, I),
                (Z[j + B + 4] = a.x),
                (Z[j + B + 5] = a.y),
                (Z[j + B + 6] = a.z),
                (Z[j + B + 7] = 0)),
              b === !0 &&
                (a.fromBufferAttribute(K, I),
                (Z[j + B + 8] = a.x),
                (Z[j + B + 9] = a.y),
                (Z[j + B + 10] = a.z),
                (Z[j + B + 11] = K.itemSize === 4 ? a.w : 1));
          }
        }
        (p = { count: _, texture: J, size: new Ce(w, W) }),
          s.set(u, p),
          u.addEventListener("dispose", k);
      }
      let f = 0;
      for (let v = 0; v < d.length; v++) f += d[v];
      const T = u.morphTargetsRelative ? 1 : 1 - f;
      ...
      for (let y = 0; y < 8; y++) {
        ...
        L !== Number.MAX_SAFE_INTEGER && A
          ? (p &&
            ...
            f &&
              u.getAttribute("morphNormal" + y) !== f[L] &&
              u.setAttribute("morphNormal" + y, f[L]),
            (i[y] = A),
            (T += A))
          : (p &&
      ...
      const v = u.morphTargetsRelative ? 1 : 1 - T;
...
function Nf(r, e) {
  ...
  if (n === void 0) {
    ...
    if (ct(t, n)) return;
    _o.set(n), r.uniformMatrix2fv(this.addr, !1, _o), lt(t, n);
  }
}
function Of(r, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (ct(t, n)) return;
    go.set(n), r.uniformMatrix3fv(this.addr, !1, go), lt(t, n);
  }
}
function Ff(r, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (ct(t, n)) return;
    mo.set(n), r.uniformMatrix4fv(this.addr, !1, mo), lt(t, n);
  }
}
function Bf(r, e) {
  const t = this.cache;
...
function Yf(r, e, t) {
  const n = this.cache,
    i = t.allocateTextureUnit();
  n[0] !== i && (r.uniform1i(this.addr, i), (n[0] = i)),
    t.setTextureCube(e || Nc, i);
}
function Kf(r, e, t) {
  const n = this.cache,
    i = t.allocateTextureUnit();
  n[0] !== i && (r.uniform1i(this.addr, i), (n[0] = i)),
    t.setTexture2DArray(e || Ic, i);
}
function Zf(r) {
  switch (r) {
    case 5126:
...
function dp(r, e, t) {
  ...
  for (let a = 0; a !== i; ++a) t.setTexture2D(e[a] || Dc, s[a]);
}
function fp(r, e, t) {
  const n = this.cache,
    i = e.length,
    s = Nr(t, i);
  ct(n, s) || (r.uniform1iv(this.addr, s), lt(n, s));
  for (let a = 0; a !== i; ++a) t.setTexture3D(e[a] || Uc, s[a]);
}
function pp(r, e, t) {
  const n = this.cache,
    i = e.length,
    s = Nr(t, i);
  ct(n, s) || (r.uniform1iv(this.addr, s), lt(n, s));
  for (let a = 0; a !== i; ++a) t.setTextureCube(e[a] || Nc, s[a]);
}
function mp(r, e, t) {
  const n = this.cache,
    i = e.length,
    s = Nr(t, i);
  ct(n, s) || (r.uniform1iv(this.addr, s), lt(n, s));
  for (let a = 0; a !== i; ++a) t.setTexture2DArray(e[a] || Ic, s[a]);
}
function gp(r) {
  switch (r) {
    case 5126:
...
function Mp(r, e, t) {
  ...
  for (ps.lastIndex = 0; ; ) {
    ...
    if ((c && (o = o | 0), l === void 0 || (l === "[" && a + 2 === i))) {
      xo(t, l === void 0 ? new _p(o, r, e) : new xp(o, r, e));
      break;
    } else {
      let h = t.map[o];
      h === void 0 && ((h = new vp(o)), xo(t, h)), (t = h);
    }
  }
}
class Ar {
...
function Ep(r) {
  ...
  switch (
    (e === t
      ...
      : e === Rr && t === Cr && (n = "LinearSRGBToLinearDisplayP3"),
    r)
  ) {
    case gt:
    case Ir:
...
`)),
      (f = [
        ...
        t.toneMapping !== Sn ? Oe.tonemapping_pars_fragment : "",
        t.toneMapping !== Sn ? Ap("toneMapping", t.toneMapping) : "",
        t.dithering ? "#define DITHERING" : "",
        t.opaque ? "#define OPAQUE" : "",
        Oe.colorspace_pars_fragment,
        Tp("linearToOutputTexel", t.outputColorSpace),
...
` +
  ...
  const v = T + p + a,
    y = T + f + o,
    b = vo(i, i.VERTEX_SHADER, v),
    L = vo(i, i.FRAGMENT_SHADER, y);
  if (
    (i.attachShader(_, b),
    i.attachShader(_, L),
...
` +
  ...
  i.deleteShader(b), i.deleteShader(L);
  let A;
  this.getUniforms = function () {
    return A === void 0 && (A = new Ar(i, _)), A;
  };
  let G;
  return (
    (this.getAttributes = function () {
      return G === void 0 && (G = Rp(i, _)), G;
    }),
...
class kp {
  constructor(e) {
    (this.id = zp++), (this.code = e), (this.usedTimes = 0);
  }
}
function Vp(r, e, t, n, i, s, a) {
  const o = new Tc(),
    c = new Gp(),
    l = [],
    u = i.isWebGL2,
  ...
  function p(M, w, W, Z, J) {
    const D = Z.fog,
      k = J.geometry,
      q = M.isMeshStandardMaterial ? Z.environment : null,
      V = (M.isMeshStandardMaterial ? t : e).get(M.envMap || q),
      ie = V && V.mapping === Dr ? V.image.height : null,
      K = g[M.type];
    M.precision !== null &&
    ...
    const j =
      ...
      I = j !== void 0 ? j.length : 0;
    let B = 0;
    k.morphAttributes.position !== void 0 && (B = 1),
      k.morphAttributes.normal !== void 0 && (B = 2),
      k.morphAttributes.color !== void 0 && (B = 3);
    let le, he, de, ye;
    if (K) {
      const Ze = Wt[K];
    ...
    const Le = r.getRenderTarget(),
      ...
      Q = ot && !!M.clearcoatMap,
      $ = ot && !!M.clearcoatNormalMap,
      ee = ot && !!M.clearcoatRoughnessMap,
      ge = ut && !!M.iridescenceMap,
      re = ut && !!M.iridescenceThicknessMap,
      ue = E && !!M.sheenColorMap,
      C = E && !!M.sheenRoughnessMap,
      te = !!M.specularMap,
      X = !!M.specularColorMap,
      Ee = !!M.specularIntensityMap,
      _e = x && !!M.transmissionMap,
      xe = x && !!M.thicknessMap,
      me = !!M.gradientMap,
      R = !!M.alphaMap,
      se = M.alphaTest > 0,
    ...
    return (
        ...
        (Te = r.toneMapping),
      {
        ...
        emissiveMap: Ke,
        normalMapObjectSpace: Pe && M.normalMapType === Gl,
        normalMapTangentSpace: Pe && M.normalMapType === _c,
        metalnessMap: Fe,
        roughnessMap: De,
        anisotropy: We,
        anisotropyMap: F,
        ...
        specularColorMapUv: X && _(M.specularColorMap.channel),
        specularIntensityMapUv: Ee && _(M.specularIntensityMap.channel),
        ...
        vertexTangents: !!k.attributes.tangent && (Pe || We),
        ...
        vertexUv2s: Y,
        vertexUv3s: pe,
        pointsUvs: J.isPoints === !0 && !!k.attributes.uv && (Ve || R),
        fog: !!D,
        useFog: M.fog === !0,
  ...
  function f(M) {
    ...
    if (
      ...
      for (const W in M.defines) w.push(W), w.push(M.defines[W]);
    return (
      M.isRawShaderMaterial === !1 &&
        (T(w, M), v(w, M), w.push(r.outputColorSpace)),
  ...
  function b(M, w) {
    ...
    return W === void 0 && ((W = new Hp(r, w, M, s)), l.push(W)), W;
  }
  function L(M) {
    if (--M.usedTimes === 0) {
      const w = l.indexOf(M);
...
function bo() {
  ...
  function l(h, d) {
    t.length > 1 && t.sort(h || Xp),
      n.length > 1 && n.sort(d || Ao),
      i.length > 1 && i.sort(d || Ao);
  }
  function u() {
    ...
    get: function (e) {
      ...
      switch (e.type) {
        case "DirectionalLight":
          t = { direction: new P(), color: new Ie() };
          break;
        case "SpotLight":
          t = {
            position: new P(),
          ...
          break;
        case "PointLight":
          t = { position: new P(), color: new Ie(), distance: 0, decay: 0 };
          break;
        case "HemisphereLight":
          t = { direction: new P(), skyColor: new Ie(), groundColor: new Ie() };
          break;
        case "RectAreaLight":
          t = {
            color: new Ie(),
  ...
  function c(u, h) {
    ...
    for (let Z = 0, J = u.length; Z < J; Z++) {
      const D = u[Z],
        ...
        q = D.intensity,
        V = D.distance,
        ie = D.shadow && D.shadow.map ? D.shadow.map.texture : null;
      if (D.isAmbientLight)
        (d += k.r * q * w), (m += k.g * q * w), (g += k.b * q * w);
      else if (D.isLightProbe) {
        for (let K = 0; K < 9; K++)
          i.probe[K].addScaledVector(D.sh.coefficients[K], q);
        M++;
      } else if (D.isDirectionalLight) {
        const K = t.get(D);
        if (
          (K.color.copy(D.color).multiplyScalar(D.intensity * w), D.castShadow)
        ) {
          const j = D.shadow,
            I = n.get(D);
          (I.shadowBias = j.bias),
        ...
        K.position.setFromMatrixPosition(D.matrixWorld),
          K.color.copy(k).multiplyScalar(q * w),
          (K.distance = V),
        ...
        if (
          ...
          (I.shadowBias = j.bias),
            ...
            (I.shadowMapSize = j.mapSize),
            (i.spotShadow[f] = I),
            (i.spotShadowMap[f] = ie),
            L++;
        }
        f++;
      } else if (D.isRectAreaLight) {
        const K = t.get(D);
        K.color.copy(k).multiplyScalar(q),
        ...
        const K = t.get(D);
        if (
          (K.color.copy(D.color).multiplyScalar(D.intensity * w),
          ...
          (I.shadowBias = j.bias),
            ...
            (I.shadowRadius = j.radius),
            (I.shadowMapSize = j.mapSize),
            (I.shadowCameraNear = j.camera.near),
            (I.shadowCameraFar = j.camera.far),
            (i.pointShadow[p] = I),
            (i.pointShadowMap[p] = ie),
        ...
        const K = t.get(D);
        K.skyColor.copy(D.color).multiplyScalar(q * w),
          K.groundColor.copy(D.groundColor).multiplyScalar(q * w),
          (i.hemi[v] = K),
          v++;
      }
    }
    ...
    (W.directionalLength !== _ ||
      ...
      (i.spotLightMatrix.length = L + A - G),
...
function Jp(r, e) {
  ...
  function n(s, a = 0) {
    ...
    return (
      o === void 0
        ? ((c = new wo(r, e)), t.set(s, [c]))
        : a >= o.length
        ? ((c = new wo(r, e)), o.push(c))
        : (c = o[a]),
      c
    );
  }
  ...
  this.render = function (b, L, A) {
    ...
    for (let D = 0, k = b.length; D < k; D++) {
      ...
      if (
        ...
        const j = this.type !== an ? { minFilter: dt, magFilter: dt } : {};
        V.map !== null && V.map.dispose(),
          (V.map = new Hn(i.x, i.y, j)),
      ...
      for (let j = 0; j < K; j++) {
        const I = V.getViewport(j);
        a.set(s.x * I.x, s.y * I.y, s.x * I.z, s.y * I.w),
          W.viewport(a),
          V.updateMatrices(q, j),
          (n = V.getFrustum()),
          y(L, A, V.camera, q, this.type);
      }
      V.isPointLightShadow !== !0 && this.type === an && T(V, A),
        (V.needsUpdate = !1);
    }
    (f = this.type), (p.needsUpdate = !1), r.setRenderTarget(G, M, w);
  };
  function T(b, L) {
    const A = e.update(_);
    d.defines.VSM_SAMPLES !== b.blurSamples &&
      ...
      (d.needsUpdate = !0),
      (m.needsUpdate = !0)),
      b.mapPass === null && (b.mapPass = new Hn(i.x, i.y)),
      ...
      r.clear(),
      r.renderBufferDirect(L, null, A, d, _, null),
      ...
      r.clear(),
      r.renderBufferDirect(L, null, A, m, _, null);
  }
  function v(b, L, A, G) {
    let M = null;
    const w =
    ...
    if (
      ...
      if (Array.isArray(J)) {
        ...
        for (let k = 0, q = D.length; k < q; k++) {
          ...
          if (ie && ie.visible) {
            const K = v(b, ie, G, M);
            r.renderBufferDirect(A, null, Z, K, b, V);
          }
        }
      } else if (J.visible) {
        const D = v(b, J, G, M);
        r.renderBufferDirect(A, null, Z, D, b, null);
      }
    }
    const W = b.children;
    for (let Z = 0, J = W.length; Z < J; Z++) y(W[Z], L, A, G, M);
  }
}
function rm(r, e, t) {
  const n = t.isWebGL2;
  function i() {
    ...
    return {
      setMask: function (ae) {
        ne !== ae && !R && (r.colorMask(ae, ae, ae, ae), (ne = ae));
      },
      setLocked: function (ae) {
        R = ae;
      },
      setClear: function (ae, Y, pe, Te, nt) {
        nt === !0 && ((ae *= Te), (Y *= Te), (pe *= Te)),
          se.set(ae, Y, pe, Te),
          ce.equals(se) === !1 && (r.clearColor(ae, Y, pe, Te), ce.copy(se));
      },
      reset: function () {
        (R = !1), (ne = null), ce.set(-1, 0, 0, 0);
      },
    };
  }
  function s() {
    ...
    return {
      setTest: function (ae) {
        ae ? Le(r.DEPTH_TEST) : ve(r.DEPTH_TEST);
      },
      setMask: function (ae) {
        se !== ae && !R && (r.depthMask(ae), (se = ae));
      },
      setFunc: function (ae) {
        if (ne !== ae) {
          switch (ae) {
      ...
      setClear: function (ae) {
        ce !== ae && (r.clearDepth(ae), (ce = ae));
      },
      reset: function () {
        (R = !1), (se = null), (ne = null), (ce = null);
      },
    };
  }
  function a() {
    ...
    return {
      setTest: function (Ze) {
        R || (Ze ? Le(r.STENCIL_TEST) : ve(r.STENCIL_TEST));
      },
      setMask: function (Ze) {
        se !== Ze && !R && (r.stencilMask(Ze), (se = Ze));
      },
      setFunc: function (Ze, Vt, vt) {
        (ne !== Ze || ce !== Vt || ae !== vt) &&
          (r.stencilFunc(Ze, Vt, vt), (ne = Ze), (ce = Vt), (ae = vt));
      },
      setOp: function (Ze, Vt, vt) {
        (Y !== Ze || pe !== Vt || Te !== vt) &&
          (r.stencilOp(Ze, Vt, vt), (Y = Ze), (pe = Vt), (Te = vt));
      },
      setLocked: function (Ze) {
        R = Ze;
      },
      setClear: function (Ze) {
        nt !== Ze && (r.clearStencil(Ze), (nt = Ze));
      },
      reset: function () {
        (R = !1),
          (se = null),
  ...
  let q = !1,
    V = 0;
  const ie = r.getParameter(r.VERSION);
  ie.indexOf("WebGL") !== -1
    ? ((V = parseFloat(/^WebGL (\d)/.exec(ie)[1])), (q = V >= 1))
    : ie.indexOf("OpenGL ES") !== -1 &&
      ((V = parseFloat(/^OpenGL ES (\d)/.exec(ie)[1])), (q = V >= 2));
  let K = null,
    j = {};
  const I = r.getParameter(r.SCISSOR_BOX),
    B = r.getParameter(r.VIEWPORT),
    le = new Ye().fromArray(I),
    he = new Ye().fromArray(B);
  function de(R, se, ne, ce) {
    ...
    for (let pe = 0; pe < ne; pe++)
      n && (R === r.TEXTURE_3D || R === r.TEXTURE_2D_ARRAY)
        ? r.texImage3D(se, 0, r.RGBA, 1, 1, ce, 0, r.RGBA, r.UNSIGNED_BYTE, ae)
        : r.texImage2D(
            se + pe,
            0,
            r.RGBA,
  ...
  const ye = {};
  (ye[r.TEXTURE_2D] = de(r.TEXTURE_2D, r.TEXTURE_2D, 1)),
    (ye[r.TEXTURE_CUBE_MAP] = de(
      r.TEXTURE_CUBE_MAP,
      r.TEXTURE_CUBE_MAP_POSITIVE_X,
      6
    )),
    n &&
      ((ye[r.TEXTURE_2D_ARRAY] = de(
        r.TEXTURE_2D_ARRAY,
        r.TEXTURE_2D_ARRAY,
        1,
        1
      )),
      (ye[r.TEXTURE_3D] = de(r.TEXTURE_3D, r.TEXTURE_3D, 1, 1))),
    o.setClear(0, 0, 0, 1),
    c.setClear(1),
    l.setClear(0),
    Le(r.DEPTH_TEST),
  ...
  function Ve(R, se) {
    return m[R] !== se
      ? (r.bindFramebuffer(R, se),
        (m[R] = se),
        n &&
          (R === r.DRAW_FRAMEBUFFER && (m[r.FRAMEBUFFER] = se),
          R === r.FRAMEBUFFER && (m[r.DRAW_FRAMEBUFFER] = se)),
        !0)
      : !1;
  }
  function ft(R, se) {
    ...
    if (R)
      if (
        ((ne = g.get(se)),
        ne === void 0 && ((ne = []), g.set(se, ne)),
        R.isWebGLMultipleRenderTargets)
      ) {
        const ae = R.texture;
        if (ne.length !== ae.length || ne[0] !== r.COLOR_ATTACHMENT0) {
          for (let Y = 0, pe = ae.length; Y < pe; Y++)
            ne[Y] = r.COLOR_ATTACHMENT0 + Y;
          (ne.length = ae.length), (ce = !0);
        }
      } else
        ne[0] !== r.COLOR_ATTACHMENT0 &&
          ((ne[0] = r.COLOR_ATTACHMENT0), (ce = !0));
    else ne[0] !== r.BACK && ((ne[0] = r.BACK), (ce = !0));
    ce &&
      (t.isWebGL2
        ? r.drawBuffers(ne)
  ...
  if (n) (N[ha] = r.MIN), (N[da] = r.MAX);
  else {
    const R = e.get("EXT_blend_minmax");
    R !== null && ((N[ha] = R.MIN_EXT), (N[da] = R.MAX_EXT));
  }
  const at = {
    [sl]: r.ZERO,
    [al]: r.ONE,
    [ol]: r.SRC_COLOR,
    [rc]: r.SRC_ALPHA,
    [fl]: r.SRC_ALPHA_SATURATE,
    [hl]: r.DST_COLOR,
    [ll]: r.DST_ALPHA,
    [cl]: r.ONE_MINUS_SRC_COLOR,
    [sc]: r.ONE_MINUS_SRC_ALPHA,
    [dl]: r.ONE_MINUS_DST_COLOR,
    [ul]: r.ONE_MINUS_DST_ALPHA,
  };
  function Me(R, se, ne, ce, ae, Y, pe, Te) {
    if (R === Mn) {
      f === !0 && (ve(r.BLEND), (f = !1));
      return;
    }
    if ((f === !1 && (Le(r.BLEND), (f = !0)), R !== nl)) {
      if (R !== T || Te !== M) {
        if (
          ((v !== li || L !== li) &&
            (r.blendEquation(r.FUNC_ADD), (v = li), (L = li)),
          Te)
        )
          switch (R) {
            case hi:
        ...
        (y = null), (b = null), (A = null), (G = null), (T = R), (M = Te);
      }
      return;
    }
    (ae = ae || se),
      ...
      (pe = pe || ce),
      (se !== v || ae !== L) &&
        (r.blendEquationSeparate(N[se], N[ae]), (v = se), (L = ae)),
      (ne !== y || ce !== b || Y !== A || pe !== G) &&
        (r.blendFuncSeparate(at[ne], at[ce], at[Y], at[pe]),
        (y = ne),
        (b = ce),
        (A = Y),
        (G = pe)),
  ...
  function Pe(R, se) {
    R.side === Xt ? ve(r.CULL_FACE) : Le(r.CULL_FACE);
    let ne = R.side === bt;
    se && (ne = !ne),
      be(ne),
    ...
    l.setTest(ce),
      ...
      R.alphaToCoverage === !0
        ...
        : ve(r.SAMPLE_ALPHA_TO_COVERAGE);
  }
  function be(R) {
    w !== R && (R ? r.frontFace(r.CW) : r.frontFace(r.CCW), (w = R));
  }
  function Ke(R) {
    R !== Qc
      ? (Le(r.CULL_FACE),
  ...
  function Fe(R) {
    R !== Z && (q && r.lineWidth(R), (Z = R));
  }
  function De(R, se, ne) {
    R
      ? (Le(r.POLYGON_OFFSET_FILL),
        (J !== se || D !== ne) && (r.polygonOffset(se, ne), (J = se), (D = ne)))
      : ve(r.POLYGON_OFFSET_FILL);
  }
  function We(R) {
    R ? Le(r.SCISSOR_TEST) : ve(r.SCISSOR_TEST);
  }
  function ot(R) {
    R === void 0 && (R = r.TEXTURE0 + k - 1),
      K !== R && (r.activeTexture(R), (K = R));
  }
  function ut(R, se, ne) {
    ne === void 0 && (K === null ? (ne = r.TEXTURE0 + k - 1) : (ne = K));
    let ce = j[ne];
    ce === void 0 && ((ce = { type: void 0, texture: void 0 }), (j[ne] = ce)),
      (ce.type !== R || ce.texture !== se) &&
        (K !== ne && (r.activeTexture(ne), (K = ne)),
        r.bindTexture(R, se || ye[R]),
        (ce.type = R),
        (ce.texture = se));
  }
  function E() {
  ...
  function X(R) {
    le.equals(R) === !1 && (r.scissor(R.x, R.y, R.z, R.w), le.copy(R));
  }
  function Ee(R) {
  ...
  function _e(R, se) {
    let ne = h.get(se);
    ne === void 0 && ((ne = new WeakMap()), h.set(se, ne));
    let ce = ne.get(R);
    ce === void 0 && ((ce = r.getUniformBlockIndex(se, R.name)), ne.set(R, ce));
  }
  function xe(R, se) {
    const ce = h.get(se).get(R);
    u.get(se) !== ce &&
      (r.uniformBlockBinding(se, ce, R.__bindingPointIndex), u.set(se, ce));
  }
  function me() {
    r.disable(r.BLEND),
...
function sm(r, e, t, n, i, s, a) {
  ...
  function T(E, x) {
    return f ? new OffscreenCanvas(E, x) : Wi("canvas");
  }
  function v(E, x, F, Q) {
    let $ = 1;
    if (
      ...
      if (
        ...
        const ee = x ? Pr : Math.floor,
          ge = ee($ * E.width),
          re = ee($ * E.height);
        _ === void 0 && (_ = T(ge, re));
        const ue = F ? T(ge, re) : _;
        return (
          (ue.width = ge),
          (ue.height = re),
          ue.getContext("2d").drawImage(E, 0, 0, ge, re),
          console.warn(
  ...
  function b(E) {
    return o
      ...
      : E.wrapS !== It ||
          E.wrapT !== It ||
          (E.minFilter !== dt && E.minFilter !== At);
  }
  function L(E, x) {
    return E.generateMipmaps && x && E.minFilter !== dt && E.minFilter !== At;
  }
  function A(E) {
    r.generateMipmap(E);
  }
  function G(E, x, F, Q, $ = !1) {
    if (o === !1) return x;
    if (E !== null) {
    ...
    if (
      (x === r.RED &&
        (F === r.FLOAT && (ee = r.R32F),
        F === r.HALF_FLOAT && (ee = r.R16F),
        F === r.UNSIGNED_BYTE && (ee = r.R8)),
      x === r.RED_INTEGER &&
        (F === r.UNSIGNED_BYTE && (ee = r.R8UI),
        F === r.UNSIGNED_SHORT && (ee = r.R16UI),
        F === r.UNSIGNED_INT && (ee = r.R32UI),
        F === r.BYTE && (ee = r.R8I),
        F === r.SHORT && (ee = r.R16I),
        F === r.INT && (ee = r.R32I)),
      x === r.RG &&
        (F === r.FLOAT && (ee = r.RG32F),
        F === r.HALF_FLOAT && (ee = r.RG16F),
        F === r.UNSIGNED_BYTE && (ee = r.RG8)),
      x === r.RGBA)
    ) {
      const ge = $ ? wr : Xe.getTransfer(Q);
      F === r.FLOAT && (ee = r.RGBA32F),
        F === r.HALF_FLOAT && (ee = r.RGBA16F),
        F === r.UNSIGNED_BYTE && (ee = ge === $e ? r.SRGB8_ALPHA8 : r.RGBA8),
        F === r.UNSIGNED_SHORT_4_4_4_4 && (ee = r.RGBA4),
        F === r.UNSIGNED_SHORT_5_5_5_1 && (ee = r.RGB5_A1);
    }
    return (
      (ee === r.R16F ||
        ee === r.R32F ||
  ...
  function M(E, x, F) {
    return L(E, F) === !0 ||
      (E.isFramebufferTexture && E.minFilter !== dt && E.minFilter !== At)
  ...
  function w(E) {
    return E === dt || E === Rs || E === Tr ? r.NEAREST : r.LINEAR;
  }
  function W(E) {
    const x = E.target;
    x.removeEventListener("dispose", W), J(x), x.isVideoTexture && g.delete(x);
  }
  function Z(E) {
    const x = E.target;
  ...
  function J(E) {
    ...
    if (Q) {
      ...
      $.usedTimes--,
        $.usedTimes === 0 && D(E),
        Object.keys(Q).length === 0 && p.delete(F);
    }
    n.remove(E);
  }
  function D(E) {
  ...
  function k(E) {
    ...
    if (E.isWebGLMultipleRenderTargets)
      for (let $ = 0, ee = x.length; $ < ee; $++) {
        const ge = n.get(x[$]);
        ge.__webglTexture &&
          (r.deleteTexture(ge.__webglTexture), a.memory.textures--),
          n.remove(x[$]);
      }
  ...
  const he = { [gi]: r.REPEAT, [It]: r.CLAMP_TO_EDGE, [br]: r.MIRRORED_REPEAT },
    de = {
      [dt]: r.NEAREST,
      [Rs]: r.NEAREST_MIPMAP_NEAREST,
      [Tr]: r.NEAREST_MIPMAP_LINEAR,
      [At]: r.LINEAR,
      [cc]: r.LINEAR_MIPMAP_NEAREST,
  ...
  function Le(E, x, F) {
    if (
      (F
        ? (r.texParameteri(E, r.TEXTURE_WRAP_S, he[x.wrapS]),
          r.texParameteri(E, r.TEXTURE_WRAP_T, he[x.wrapT]),
          (E === r.TEXTURE_3D || E === r.TEXTURE_2D_ARRAY) &&
            r.texParameteri(E, r.TEXTURE_WRAP_R, he[x.wrapR]),
          r.texParameteri(E, r.TEXTURE_MAG_FILTER, de[x.magFilter]),
          r.texParameteri(E, r.TEXTURE_MIN_FILTER, de[x.minFilter]))
        : (r.texParameteri(E, r.TEXTURE_WRAP_S, r.CLAMP_TO_EDGE),
          r.texParameteri(E, r.TEXTURE_WRAP_T, r.CLAMP_TO_EDGE),
          (E === r.TEXTURE_3D || E === r.TEXTURE_2D_ARRAY) &&
            r.texParameteri(E, r.TEXTURE_WRAP_R, r.CLAMP_TO_EDGE),
          (x.wrapS !== It || x.wrapT !== It) &&
            console.warn(
              "THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."
            ),
          r.texParameteri(E, r.TEXTURE_MAG_FILTER, w(x.magFilter)),
          r.texParameteri(E, r.TEXTURE_MIN_FILTER, w(x.minFilter)),
          x.minFilter !== dt &&
            x.minFilter !== At &&
            console.warn(
      ...
      x.compareFunction &&
        ...
        r.texParameteri(E, r.TEXTURE_COMPARE_FUNC, ye[x.compareFunction])),
      e.has("EXT_texture_filter_anisotropic") === !0)
    ) {
      const Q = e.get("EXT_texture_filter_anisotropic");
      if (
        x.magFilter === dt ||
        (x.minFilter !== Tr && x.minFilter !== Bn) ||
  ...
  function ve(E, x) {
    ...
    if (ee !== E.__cacheKey) {
      $[ee] === void 0 &&
        (($[ee] = { texture: r.createTexture(), usedTimes: 0 }),
        a.memory.textures++,
        (F = !0)),
        $[ee].usedTimes++;
      const ge = $[E.__cacheKey];
      ge !== void 0 &&
        ($[E.__cacheKey].usedTimes--, ge.usedTimes === 0 && D(x)),
        (E.__cacheKey = ee),
  ...
  function Ve(E, x, F) {
    ...
    (x.isDataArrayTexture || x.isCompressedArrayTexture) &&
      (Q = r.TEXTURE_2D_ARRAY),
      x.isData3DTexture && (Q = r.TEXTURE_3D);
    const $ = ve(E, x),
      ee = x.source;
    t.bindTexture(Q, E.__webglTexture, r.TEXTURE0 + F);
    const ge = n.get(ee);
    if (ee.version !== ge.__version || $ === !0) {
      t.activeTexture(r.TEXTURE0 + F);
      const re = Xe.getPrimaries(Xe.workingColorSpace),
        ue = x.colorSpace === Nt ? null : Xe.getPrimaries(x.colorSpace),
        C = x.colorSpace === Nt || re === ue ? r.NONE : r.BROWSER_DEFAULT_WEBGL;
      r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL, x.flipY),
        ...
        r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL, C);
      const te = b(x) && y(x.image) === !1;
      let X = v(x.image, te, !1, u);
      X = ut(x, X);
      const Ee = y(X) || o,
        _e = s.convert(x.format, x.colorSpace);
      let xe = s.convert(x.type),
        me = G(x.internalFormat, _e, xe, x.colorSpace, x.isVideoTexture);
      Le(Q, x, Ee);
      let R;
      const se = x.mipmaps,
        ne = o && x.isVideoTexture !== !0,
        ce = ge.__version === void 0 || $ === !0,
        ae = M(x, X, Ee);
      if (x.isDepthTexture)
        (me = r.DEPTH_COMPONENT),
          ...
          ce &&
            (ne
              ? t.texStorage2D(r.TEXTURE_2D, 1, me, X.width, X.height)
              : t.texImage2D(
                  r.TEXTURE_2D,
                  0,
                  me,
        ...
        if (se.length > 0 && Ee) {
          ne &&
            ce &&
            t.texStorage2D(r.TEXTURE_2D, ae, me, se[0].width, se[0].height);
          for (let Y = 0, pe = se.length; Y < pe; Y++)
            (R = se[Y]),
              ne
                ? t.texSubImage2D(
                    r.TEXTURE_2D,
          ...
          ne
            ? (ce && t.texStorage2D(r.TEXTURE_2D, ae, me, X.width, X.height),
              t.texSubImage2D(
                r.TEXTURE_2D,
                0,
                0,
        ...
        ne
          ? (ce &&
              t.texStorage3D(r.TEXTURE_3D, ae, me, X.width, X.height, X.depth),
            t.texSubImage3D(
              r.TEXTURE_3D,
              0,
              0,
        ...
        if (ce)
          if (ne) t.texStorage2D(r.TEXTURE_2D, ae, me, X.width, X.height);
          else {
            let Y = X.width,
              pe = X.height;
            for (let Te = 0; Te < ae; Te++)
              t.texImage2D(r.TEXTURE_2D, Te, me, Y, pe, 0, _e, xe, null),
                (Y >>= 1),
                (pe >>= 1);
          }
      } else if (se.length > 0 && Ee) {
        ne &&
          ce &&
          t.texStorage2D(r.TEXTURE_2D, ae, me, se[0].width, se[0].height);
        for (let Y = 0, pe = se.length; Y < pe; Y++)
          (R = se[Y]),
            ne
              ? t.texSubImage2D(r.TEXTURE_2D, Y, 0, 0, _e, xe, R)
              : t.texImage2D(r.TEXTURE_2D, Y, me, _e, xe, R);
        x.generateMipmaps = !1;
      } else
        ne
          ? (ce && t.texStorage2D(r.TEXTURE_2D, ae, me, X.width, X.height),
            t.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, _e, xe, X))
          : t.texImage2D(r.TEXTURE_2D, 0, me, _e, xe, X);
      L(x, Ee) && A(Q),
  ...
  function ft(E, x, F) {
    ...
    if ($.version !== ee.__version || Q === !0) {
      ...
      const ge = Xe.getPrimaries(Xe.workingColorSpace),
        re = x.colorSpace === Nt ? null : Xe.getPrimaries(x.colorSpace),
        ue =
          x.colorSpace === Nt || ge === re ? r.NONE : r.BROWSER_DEFAULT_WEBGL;
      r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL, x.flipY),
        r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL, x.premultiplyAlpha),
        r.pixelStorei(r.UNPACK_ALIGNMENT, x.unpackAlignment),
        r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL, ue);
      const C = x.isCompressedTexture || x.image[0].isCompressedTexture,
        te = x.image[0] && x.image[0].isDataTexture,
        X = [];
      for (let Y = 0; Y < 6; Y++)
        !C && !te
          ? (X[Y] = v(x.image[Y], !1, !0, l))
          : (X[Y] = te ? x.image[Y].image : x.image[Y]),
          (X[Y] = ut(x, X[Y]));
      const Ee = X[0],
        _e = y(Ee) || o,
        xe = s.convert(x.format, x.colorSpace),
        me = s.convert(x.type),
        R = G(x.internalFormat, xe, me, x.colorSpace),
        se = o && x.isVideoTexture !== !0,
        ne = ee.__version === void 0 || Q === !0;
      let ce = M(x, Ee, _e);
      Le(r.TEXTURE_CUBE_MAP, x, _e);
      let ae;
      if (C) {
        se &&
          ne &&
          t.texStorage2D(r.TEXTURE_CUBE_MAP, ce, R, Ee.width, Ee.height);
        for (let Y = 0; Y < 6; Y++) {
          ae = X[Y].mipmaps;
        ...
        (ae = x.mipmaps),
          se &&
            ne &&
            (ae.length > 0 && ce++,
            t.texStorage2D(r.TEXTURE_CUBE_MAP, ce, R, X[0].width, X[0].height));
        for (let Y = 0; Y < 6; Y++)
          if (te) {
            se
              ? t.texSubImage2D(
      ...
      L(x, _e) && A(r.TEXTURE_CUBE_MAP),
        (ee.__version = $.version),
        x.onUpdate && x.onUpdate(x);
    }
    E.__version = x.version;
  }
  function Ue(E, x, F, Q, $, ee) {
    const ge = s.convert(F.format, F.colorSpace),
      re = s.convert(F.type),
      ue = G(F.internalFormat, ge, re, F.colorSpace);
    if (!n.get(x).__hasExternalTextures) {
      const te = Math.max(1, x.width >> ee),
        X = Math.max(1, x.height >> ee);
      $ === r.TEXTURE_3D || $ === r.TEXTURE_2D_ARRAY
        ? t.texImage3D($, ee, ue, te, X, x.depth, 0, ge, re, null)
        : t.texImage2D($, ee, ue, te, X, 0, ge, re, null);
    }
    t.bindFramebuffer(r.FRAMEBUFFER, E),
      We(x)
  ...
  function N(E, x, F) {
    if (
      (r.bindRenderbuffer(r.RENDERBUFFER, E), x.depthBuffer && !x.stencilBuffer)
    ) {
      ...
      if (F || We(x)) {
        ...
        $ &&
          $.isDepthTexture &&
          ($.type === on
            ? (Q = r.DEPTH_COMPONENT32F)
            : $.type === vn && (Q = r.DEPTH_COMPONENT24));
        const ee = De(x);
        We(x)
      ...
      } else r.renderbufferStorage(r.RENDERBUFFER, Q, x.width, x.height);
      ...
      for (let $ = 0; $ < Q.length; $++) {
        const ee = Q[$],
          ge = s.convert(ee.format, ee.colorSpace),
          re = s.convert(ee.type),
          ue = G(ee.internalFormat, ge, re, ee.colorSpace),
          C = De(x);
        F && We(x) === !1
          ? r.renderbufferStorageMultisample(
              r.RENDERBUFFER,
          ...
          : r.renderbufferStorage(r.RENDERBUFFER, ue, x.width, x.height);
      }
    }
  ...
  function Me(E) {
    ...
    if (E.depthTexture && !x.__autoAllocateDepthBuffer) {
      ...
      at(x.__webglFramebuffer, E);
    } else if (F) {
      x.__webglDepthbuffer = [];
      for (let Q = 0; Q < 6; Q++)
        t.bindFramebuffer(r.FRAMEBUFFER, x.__webglFramebuffer[Q]),
          (x.__webglDepthbuffer[Q] = r.createRenderbuffer()),
          N(x.__webglDepthbuffer[Q], E, !1);
    } else
      t.bindFramebuffer(r.FRAMEBUFFER, x.__webglFramebuffer),
        (x.__webglDepthbuffer = r.createRenderbuffer()),
        N(x.__webglDepthbuffer, E, !1);
    t.bindFramebuffer(r.FRAMEBUFFER, null);
  }
  function Pe(E, x, F) {
    const Q = n.get(E);
    ...
    if ($) {
      ...
      for (let re = 0; re < 6; re++)
        if (o && x.mipmaps && x.mipmaps.length > 0) {
          ...
          for (let ue = 0; ue < x.mipmaps.length; ue++)
            F.__webglFramebuffer[re][ue] = r.createFramebuffer();
        } else F.__webglFramebuffer[re] = r.createFramebuffer();
    } else {
      if (o && x.mipmaps && x.mipmaps.length > 0) {
        F.__webglFramebuffer = [];
      ...
      if (o && E.samples > 0 && We(E) === !1) {
        ...
        for (let ue = 0; ue < re.length; ue++) {
          const C = re[ue];
          (F.__webglColorRenderbuffer[ue] = r.createRenderbuffer()),
            r.bindRenderbuffer(r.RENDERBUFFER, F.__webglColorRenderbuffer[ue]);
        ...
        r.bindRenderbuffer(r.RENDERBUFFER, null),
          E.depthBuffer &&
            ...
            N(F.__webglDepthRenderbuffer, E, !0)),
          t.bindFramebuffer(r.FRAMEBUFFER, null);
      }
    }
    if ($) {
      t.bindTexture(r.TEXTURE_CUBE_MAP, Q.__webglTexture),
        Le(r.TEXTURE_CUBE_MAP, x, ge);
      for (let re = 0; re < 6; re++)
        if (o && x.mipmaps && x.mipmaps.length > 0)
          for (let ue = 0; ue < x.mipmaps.length; ue++)
            Ue(
              F.__webglFramebuffer[re][ue],
              E,
              x,
              r.COLOR_ATTACHMENT0,
      ...
      L(x, ge) && A(r.TEXTURE_CUBE_MAP), t.unbindTexture();
    } else if (ee) {
      const re = E.texture;
      for (let ue = 0, C = re.length; ue < C; ue++) {
        const te = re[ue],
          X = n.get(te);
        t.bindTexture(r.TEXTURE_2D, X.__webglTexture),
          Le(r.TEXTURE_2D, te, ge),
          Ue(
            F.__webglFramebuffer,
            E,
            te,
      ...
      if (
        ((E.isWebGL3DRenderTarget || E.isWebGLArrayRenderTarget) &&
          (o
            ? (re = E.isWebGL3DRenderTarget ? r.TEXTURE_3D : r.TEXTURE_2D_ARRAY)
            : console.error(
        ...
        for (let ue = 0; ue < x.mipmaps.length; ue++)
          Ue(F.__webglFramebuffer[ue], E, x, r.COLOR_ATTACHMENT0, re, ue);
      else Ue(F.__webglFramebuffer, E, x, r.COLOR_ATTACHMENT0, re, 0);
      L(x, ge) && A(re), t.unbindTexture();
    }
    E.depthBuffer && Me(E);
  }
  function Ke(E) {
    ...
    for (let Q = 0, $ = F.length; Q < $; Q++) {
      const ee = F[Q];
      if (L(ee, x)) {
        const ge = E.isWebGLCubeRenderTarget
            ? r.TEXTURE_CUBE_MAP
            : r.TEXTURE_2D,
          re = n.get(ee).__webglTexture;
        t.bindTexture(ge, re), A(ge), t.unbindTexture();
      }
    }
  }
  function Fe(E) {
    if (o && E.samples > 0 && We(E) === !1) {
      ...
      const ee = [],
        ge = E.stencilBuffer ? r.DEPTH_STENCIL_ATTACHMENT : r.DEPTH_ATTACHMENT,
        re = n.get(E),
      ...
      for (let C = 0; C < x.length; C++) {
        ee.push(r.COLOR_ATTACHMENT0 + C), E.depthBuffer && ee.push(ge);
        const te =
          re.__ignoreDepthValues !== void 0 ? re.__ignoreDepthValues : !1;
        if (
          (te === !1 &&
            (E.depthBuffer && ($ |= r.DEPTH_BUFFER_BIT),
            E.stencilBuffer && ($ |= r.STENCIL_BUFFER_BIT)),
          ue &&
            r.framebufferRenderbuffer(
              r.READ_FRAMEBUFFER,
              r.COLOR_ATTACHMENT0,
          ...
          te === !0 &&
            (r.invalidateFramebuffer(r.READ_FRAMEBUFFER, [ge]),
            r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER, [ge])),
          ue)
        ) {
          const X = n.get(x[C]).__webglTexture;
          r.framebufferTexture2D(
            r.DRAW_FRAMEBUFFER,
            r.COLOR_ATTACHMENT0,
            r.TEXTURE_2D,
        ...
        r.blitFramebuffer(0, 0, F, Q, 0, 0, F, Q, $, r.NEAREST),
      ...
      if (
        ...
        for (let C = 0; C < x.length; C++) {
          ...
          const te = n.get(x[C]).__webglTexture;
          t.bindFramebuffer(r.FRAMEBUFFER, re.__webglFramebuffer),
            r.framebufferTexture2D(
              r.DRAW_FRAMEBUFFER,
              r.COLOR_ATTACHMENT0 + C,
...
function am(r, e, t) {
  ...
  function i(s, a = Nt) {
    ...
    if (s === uc) return r.UNSIGNED_SHORT_4_4_4_4;
    if (s === hc) return r.UNSIGNED_SHORT_5_5_5_1;
    if (s === Rl) return r.BYTE;
    if (s === Cl) return r.SHORT;
    if (s === Hs) return r.UNSIGNED_SHORT;
    if (s === lc) return r.INT;
    ...
    if (s === Ll) return r.ALPHA;
    if (s === Ut) return r.RGBA;
    if (s === Pl) return r.LUMINANCE;
    if (s === Dl) return r.LUMINANCE_ALPHA;
    if (s === On) return r.DEPTH_COMPONENT;
    if (s === _i) return r.DEPTH_STENCIL;
    if (s === Ps)
      return (o = e.get("EXT_sRGB")), o !== null ? o.SRGB_ALPHA_EXT : null;
    if (s === Il) return r.RED;
    if (s === dc) return r.RED_INTEGER;
    if (s === Ul) return r.RG;
    if (s === fc) return r.RG_INTEGER;
    if (s === pc) return r.RGBA_INTEGER;
    if (s === kr || s === Vr || s === Wr || s === Xr)
      if (c === $e)
        if (((o = e.get("WEBGL_compressed_texture_s3tc_srgb")), o !== null)) {
          if (s === kr) return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;
          if (s === Vr) return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
          if (s === Wr) return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;
        ...
        if (s === Wr) return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;
        if (s === Xr) return o.COMPRESSED_RGBA_S3TC_DXT5_EXT;
      } else return null;
    if (s === fa || s === pa || s === ma || s === ga)
      if (((o = e.get("WEBGL_compressed_texture_pvrtc")), o !== null)) {
        if (s === fa) return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
        if (s === pa) return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
        if (s === ma) return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
        if (s === ga) return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
      } else return null;
    if (s === Nl)
      return (
    ...
    if (s === qr || s === Ia || s === Ua)
      if (((o = e.get("EXT_texture_compression_bptc")), o !== null)) {
        ...
        if (s === Ia) return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
        if (s === Ua) return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
    if (s === Ol || s === Na || s === Oa || s === Fa)
      if (((o = e.get("EXT_texture_compression_rgtc")), o !== null)) {
        if (s === qr) return o.COMPRESSED_RED_RGTC1_EXT;
        if (s === Na) return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;
        if (s === Oa) return o.COMPRESSED_RED_GREEN_RGTC2_EXT;
        if (s === Fa) return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;
      } else return null;
    return s === Nn
      ? n
        ? r.UNSIGNED_INT_24_8
  ...
  constructor(e, t) {
    ...
    (this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (I) {
        let B = T[I];
        return (
          B === void 0 && ((B = new ms()), (T[I] = B)), B.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (I) {
        let B = T[I];
        return B === void 0 && ((B = new ms()), (T[I] = B)), B.getGripSpace();
      }),
      (this.getHand = function (I) {
        let B = T[I];
        return B === void 0 && ((B = new ms()), (T[I] = B)), B.getHandSpace();
      });
    function w(I) {
      const B = v.indexOf(I.inputSource);
      if (B === -1) return;
      const le = T[B];
      le !== void 0 &&
    ...
    function W() {
      ...
      for (let I = 0; I < T.length; I++) {
        const B = v[I];
        B !== null && ((v[I] = null), T[I].disconnect(B));
      }
      (G = null),
        (M = null),
        e.setRenderTarget(p),
      ...
      (this.setSession = async function (I) {
        if (((i = I), i !== null)) {
          if (
            ...
            (m = new XRWebGLLayer(i, t, B)),
              i.updateRenderState({ baseLayer: m }),
              (f = new Hn(m.framebufferWidth, m.framebufferHeight, {
                format: Ut,
                type: yn,
    ...
    function Z(I) {
      for (let B = 0; B < I.removed.length; B++) {
        const le = I.removed[B],
          he = v.indexOf(le);
        he >= 0 && ((v[he] = null), T[he].disconnect(le));
      }
    ...
    function k(I, B, le) {
      ...
      const he = J.distanceTo(D),
        de = B.projectionMatrix.elements,
        ye = le.projectionMatrix.elements,
        Le = de[14] / (de[10] - 1),
        ve = de[14] / (de[10] + 1),
        Ve = (de[9] + 1) / de[5],
        ft = (de[9] - 1) / de[5],
    ...
    this.updateCamera = function (I) {
      if (i === null) return;
      (A.near = b.near = y.near = I.near),
        (A.far = b.far = y.far = I.far),
        (G !== A.near || M !== A.far) &&
      ...
      const B = I.parent,
        le = A.cameras;
      q(A, B);
      for (let he = 0; he < le.length; he++) q(le[he], B);
      le.length === 2
        ? k(A, y, b)
    ...
    function V(I, B, le) {
      le === null
        ? I.matrix.copy(B.matrixWorld)
        : (I.matrix.copy(le.matrixWorld),
          I.matrix.invert(),
          I.matrix.multiply(B.matrixWorld)),
        I.matrix.decompose(I.position, I.quaternion, I.scale),
        I.updateMatrixWorld(!0),
        I.projectionMatrix.copy(B.projectionMatrix),
        I.projectionMatrixInverse.copy(B.projectionMatrixInverse),
    ...
    let ie = null;
    function K(I, B) {
      if (((u = B.getViewerPose(l || a)), (g = B), u !== null)) {
        const le = u.views;
        m !== null &&
        ...
        for (let de = 0; de < le.length; de++) {
          const ye = le[de];
          let Le = null;
          if (m !== null) Le = m.getViewport(ye);
          else {
            const Ve = h.getViewSubImage(d, ye);
            (Le = Ve.viewport),
              de === 0 &&
...
function hm(r, e) {
  ...
  function i(p, f, T, v, y) {
    f.isMeshBasicMaterial || f.isMeshLambertMaterial
      ...
      ? (s(p, f), d(p, f), f.isMeshPhysicalMaterial && m(p, f, y))
    ...
    (p.ior.value = f.ior),
      ...
      f.clearcoat > 0 &&
        ...
        f.clearcoatNormalMap &&
          ...
          f.side === bt && p.clearcoatNormalScale.value.negate())),
      f.iridescence > 0 &&
...
function dm(r, e, t, n) {
  ...
  function l(T, v) {
    let y = i[T.id];
    y === void 0 &&
      (g(T), (y = u(T)), (i[T.id] = y), T.addEventListener("dispose", p));
    const b = v.program;
    n.updateUBOMapping(T, b);
    const L = e.render.frame;
    s[T.id] !== L && (d(T), (s[T.id] = L));
  }
  function u(T) {
    const v = h();
    ...
    return (
      ...
      r.bufferData(r.UNIFORM_BUFFER, b, L),
      r.bindBuffer(r.UNIFORM_BUFFER, null),
      r.bindBufferBase(r.UNIFORM_BUFFER, v, y),
      y
    );
  }
  function h() {
    ...
    for (let L = 0, A = y.length; L < A; L++) {
      ...
      if (m(G, L, b) === !0) {
        ...
        for (let Z = 0; Z < w.length; Z++) {
          ...
          typeof J == "number"
            ? ((G.__data[0] = J),
              r.bufferSubData(r.UNIFORM_BUFFER, M + W, G.__data))
            : J.isMatrix3
            ? ((G.__data[0] = J.elements[0]),
              (G.__data[1] = J.elements[1]),
              (G.__data[2] = J.elements[2]),
              (G.__data[3] = J.elements[0]),
              (G.__data[4] = J.elements[3]),
              (G.__data[5] = J.elements[4]),
              (G.__data[6] = J.elements[5]),
              (G.__data[7] = J.elements[0]),
              (G.__data[8] = J.elements[6]),
              (G.__data[9] = J.elements[7]),
              (G.__data[10] = J.elements[8]),
              (G.__data[11] = J.elements[0]))
            : (J.toArray(G.__data, W),
              (W += D.storage / Float32Array.BYTES_PER_ELEMENT));
        }
        r.bufferSubData(r.UNIFORM_BUFFER, M, G.__data);
      }
    }
    r.bindBuffer(r.UNIFORM_BUFFER, null);
  }
  function m(T, v, y) {
    const b = T.value;
    if (y[v] === void 0) {
      if (typeof b == "number") y[v] = b;
      else {
        const L = Array.isArray(b) ? b : [b],
          A = [];
        for (let G = 0; G < L.length; G++) A.push(L[G].clone());
        y[v] = A;
      }
      return !0;
      ...
      const L = Array.isArray(y[v]) ? y[v] : [y[v]],
        A = Array.isArray(b) ? b : [b];
      for (let G = 0; G < L.length; G++) {
        const M = L[G];
        if (M.equals(A[G]) === !1) return M.copy(A[G]), !0;
      }
    }
    return !1;
  }
  function g(T) {
    ...
    for (let A = 0, G = v.length; A < G; A++) {
      ...
      for (let Z = 0, J = W.length; Z < J; Z++) {
        const D = W[Z],
          k = _(D);
        (w.boundary += k.boundary), (w.storage += k.storage);
      }
      if (
        ...
        L = y % b;
        const Z = b - L;
        L !== 0 && Z - w.boundary < 0 && ((y += b - L), (M.__offset = y));
      }
      y += w.storage;
    }
    return (
      (L = y % b), L > 0 && (y += b - L), (T.__size = y), (T.__cache = {}), this
    );
  }
  function _(T) {
  ...
  function f() {
    for (const T in i) r.deleteBuffer(i[T]);
    (a = []), (i = {}), (s = {});
  }
...
class Oc {
  constructor(e = {}) {
    ...
    try {
      ...
      if (
        ...
        if (
          (v.isWebGL1Renderer === !0 && U.shift(), (N = at(U, S)), N === null)
        )
          throw at(U)
            ? new Error(
    ...
    function me() {
      (Me = new Ef(N)),
        ...
        (Ke = new bf(N)),
        (Fe = new Wp()),
        (De = new sm(N, Me, be, Fe, Pe, Ee, Ke)),
        (We = new vf(v)),
        (ot = new yf(v)),
        (ut = new Nu(N, Pe)),
        (_e = new mf(N, Me, ut, Pe)),
        (E = new Tf(N, ut, Ke, _e)),
        (x = new Lf(N, E, ut, Ke)),
        (C = new Cf(N, Pe, De)),
        (ge = new xf(Fe)),
        (F = new Vp(v, We, ot, Me, Pe, _e, ge)),
        (Q = new hm(v, Fe)),
        ($ = new qp()),
        (ee = new Jp(Me, Pe)),
        (ue = new pf(v, We, ot, be, x, d, c)),
        (re = new im(v, x, Pe)),
        (xe = new dm(N, Ke, Pe, be)),
        (te = new gf(N, Me, Ke, Pe)),
        (X = new Af(N, Me, Ke, Pe)),
    ...
    (this.xr = R),
      ...
      (this.setPixelRatio = function (S) {
        S !== void 0 && ((V = S), this.setSize(k, q, !1));
      }),
      (this.getSize = function (S) {
        return S.set(k, q);
      }),
      (this.setSize = function (S, U, H = !0) {
        if (R.isPresenting) {
          console.warn(
        ...
        (k = S),
          ...
          H === !0 && ((t.style.width = S + "px"), (t.style.height = U + "px")),
          this.setViewport(0, 0, S, U);
      }),
      (this.getDrawingBufferSize = function (S) {
        return S.set(k * V, q * V).floor();
      }),
      (this.setDrawingBufferSize = function (S, U, H) {
        (k = S),
          (q = U),
          (V = H),
      ...
      (this.setViewport = function (S, U, H, O) {
        S.isVector4 ? j.set(S.x, S.y, S.z, S.w) : j.set(S, U, H, O),
          be.viewport(w.copy(j).multiplyScalar(V).floor());
      }),
      (this.getScissor = function (S) {
        return S.copy(I);
      }),
      (this.setScissor = function (S, U, H, O) {
        S.isVector4 ? I.set(S.x, S.y, S.z, S.w) : I.set(S, U, H, O),
          be.scissor(W.copy(I).multiplyScalar(V).floor());
      }),
      (this.getScissorTest = function () {
        return B;
      }),
      (this.setScissorTest = function (S) {
        be.setScissorTest((B = S));
      }),
      ...
      (this.clear = function (S = !0, U = !0, H = !0) {
        let O = 0;
        if (S) {
          let z = !1;
          if (A !== null) {
      ...
      (this.dispose = function () {
        t.removeEventListener("webglcontextlost", se, !1),
          ...
          R.removeEventListener("sessionend", Vt),
    ...
    function ae(S) {
      const U = S.target;
      U.removeEventListener("dispose", ae), Y(U);
    }
    function Y(S) {
      pe(S), Fe.remove(S);
    }
    ...
    (this.renderBufferDirect = function (S, U, H, O, z, fe) {
      U === null && (U = ft);
      ...
      let Re = H.index,
        ze = 1;
      if (O.wireframe === !0) {
        if (((Re = E.getWireframeAttribute(H)), Re === void 0)) return;
        ze = 2;
      }
      const Ae = H.drawRange,
        Ne = H.attributes.position;
      let Qe = Ae.start * ze,
      ...
      fe !== null &&
        ...
        Re !== null
          ...
          : Ne != null &&
            ((Qe = Math.max(Qe, 0)), (tt = Math.min(tt, Ne.count)));
      const Lt = tt - Qe;
      if (Lt < 0 || Lt === 1 / 0) return;
      _e.setup(z, O, we, H, Re);
      let $t,
        it = te;
      if (
        (Re !== null && (($t = ut.get(Re)), (it = X), it.setIndex($t)),
        z.isMesh)
      )
        O.wireframe === !0
          ? (be.setLineWidth(O.wireframeLinewidth * Ue()), it.setMode(N.LINES))
          : it.setMode(N.TRIANGLES);
      else if (z.isLine) {
        let Ge = O.linewidth;
        Ge === void 0 && (Ge = 1),
          be.setLineWidth(Ge * Ue()),
          z.isLineSegments
            ? it.setMode(N.LINES)
            : z.isLineLoop
        ...
        z.isPoints
          ? it.setMode(N.POINTS)
          : z.isSprite && it.setMode(N.TRIANGLES);
      if (z.isInstancedMesh) it.renderInstances(Qe, Lt, z.count);
      else if (H.isInstancedBufferGeometry) {
        const Ge = H._maxInstanceCount !== void 0 ? H._maxInstanceCount : 1 / 0,
          Br = Math.min(H.instanceCount, Ge);
        it.renderInstances(Qe, Lt, Br);
      } else it.render(Qe, Lt);
    }),
      (this.compile = function (S, U) {
        function H(O, z, fe) {
          O.transparent === !0 && O.side === Xt && O.forceSinglePass === !1
            ? ((O.side = bt),
              (O.needsUpdate = !0),
              Zi(O, z, fe),
              (O.side = ln),
    ...
    vt.setAnimationLoop(nt),
      ...
      R.addEventListener("sessionend", Vt),
      (this.render = function (S, U) {
        ...
        S.matrixWorldAutoUpdate === !0 && S.updateMatrixWorld(),
          ...
          R.enabled === !0 &&
            ...
            (U = R.getCamera())),
          S.isScene === !0 && S.onBeforeRender(v, S, U, A),
          (p = ee.get(S, T.length)),
          p.init(),
          T.push(p),
          ...
          _.init(),
          f.push(_),
          ta(S, U, 0, v.sortObjects),
          _.finish(),
          v.sortObjects === !0 && _.sort(ie, K),
        ...
        if (
          ...
          const O = U.cameras;
          for (let z = 0, fe = O.length; z < fe; z++) {
            const Se = O[z];
            na(_, S, Se, Se.viewport);
          }
        } else na(_, S, U);
        A !== null &&
          (De.updateMultisampleRenderTarget(A), De.updateRenderTargetMipmap(A)),
          S.isScene === !0 && S.onAfterRender(v, S, U),
      ...
      if (S.layers.test(U.layers)) {
        if (S.isGroup) H = S.renderOrder;
          ...
          if (!S.frustumCulled || le.intersectsSprite(S)) {
            ...
            const Se = x.update(S),
              we = S.material;
            we.visible && _.push(S, Se, we, H, Ve.z, null);
          }
        } else if (
          ...
          if (
            ...
            for (let ze = 0, Ae = Re.length; ze < Ae; ze++) {
              const Ne = Re[ze],
                Qe = we[Ne.materialIndex];
              Qe && Qe.visible && _.push(S, Se, Qe, H, Ve.z, Ne);
            }
          } else we.visible && _.push(S, Se, we, H, Ve.z, null);
        }
      }
      const fe = S.children;
      for (let Se = 0, we = fe.length; Se < we; Se++) ta(fe[Se], U, H, O);
    }
    function na(S, U, H, O) {
      const z = S.opaque,
        fe = S.transmissive,
        Se = S.transparent;
      p.setupLightsView(H),
        he === !0 && ge.setGlobalState(v.clippingPlanes, H),
        fe.length > 0 && Yc(z, fe, U, H),
        O && be.viewport(w.copy(O)),
        z.length > 0 && Ki(z, U, H),
        fe.length > 0 && Ki(fe, U, H),
        Se.length > 0 && Ki(Se, U, H),
    ...
    function Yc(S, U, H, O) {
      ...
      ye === null &&
        ...
        v.getDrawingBufferSize(ve),
        z ? ye.setSize(ve.x, ve.y) : ye.setSize(Pr(ve.x), Pr(ve.y));
      const fe = v.getRenderTarget();
      v.setRenderTarget(ye),
        v.getClearColor(J),
        (D = v.getClearAlpha()),
        D < 1 && v.setClearColor(16777215, 0.5),
        v.clear();
      const Se = v.toneMapping;
      (v.toneMapping = Sn),
        Ki(S, H, O),
        De.updateMultisampleRenderTarget(ye),
        De.updateRenderTargetMipmap(ye);
      let we = !1;
      for (let Re = 0, ze = U.length; Re < ze; Re++) {
        const Ae = U[Re],
          ...
          tt = Ae.material,
          Lt = Ae.group;
        if (tt.side === Xt && Ne.layers.test(O.layers)) {
          const $t = tt.side;
          (tt.side = bt),
            (tt.needsUpdate = !0),
            ia(Ne, H, O, Qe, tt, Lt),
      ...
      we === !0 &&
        (De.updateMultisampleRenderTarget(ye), De.updateRenderTargetMipmap(ye)),
        v.setRenderTarget(fe),
        v.setClearColor(J, D),
        (v.toneMapping = Se);
    }
    function Ki(S, U, H) {
      const O = U.isScene === !0 ? U.overrideMaterial : null;
      for (let z = 0, fe = S.length; z < fe; z++) {
        const Se = S[z],
          we = Se.object,
          Re = Se.geometry,
          ze = O === null ? Se.material : O,
          Ae = Se.group;
        we.layers.test(H.layers) && ia(we, U, H, Re, ze, Ae);
      }
    }
    function ia(S, U, H, O, z, fe) {
      S.onBeforeRender(v, U, H, O, z, fe),
        S.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse, S.matrixWorld),
        S.normalMatrix.getNormalMatrix(S.modelViewMatrix),
        z.onBeforeRender(v, U, H, O, S, fe),
        z.transparent === !0 && z.side === Xt && z.forceSinglePass === !1
          ? ((z.side = bt),
            (z.needsUpdate = !0),
            v.renderBufferDirect(H, U, O, z, S, fe),
            (z.side = ln),
            (z.needsUpdate = !0),
            v.renderBufferDirect(H, U, O, z, S, fe),
            (z.side = Xt))
          : v.renderBufferDirect(H, U, O, z, S, fe),
        S.onAfterRender(v, U, H, O, z, fe);
    }
    function Zi(S, U, H) {
      U.isScene !== !0 && (U = ft);
      const O = Fe.get(S),
        ...
        Se = z.state.version,
        we = F.getParameters(S, z.state, fe, U, H),
      ...
      if (Ae !== void 0) {
        ...
        (we.uniforms = F.getUniforms(S)),
          S.onBuild(H, we, v),
          S.onBeforeCompile(we, v),
          (Ae = F.acquireProgram(we, Re)),
          ze.set(Re, Ae),
          (O.uniforms = we.uniforms);
      const Ne = O.uniforms;
      ((!S.isShaderMaterial && !S.isRawShaderMaterial) || S.clipping === !0) &&
        (Ne.clippingPlanes = ge.uniform),
        ra(S, we),
        (O.needsLights = $c(S)),
        (O.lightsStateVersion = Se),
        O.needsLights &&
          ((Ne.ambientLightColor.value = z.state.ambient),
          (Ne.lightProbe.value = z.state.probe),
          (Ne.directionalLights.value = z.state.directional),
          (Ne.directionalLightShadows.value = z.state.directionalShadow),
          (Ne.spotLights.value = z.state.spot),
          (Ne.spotLightShadows.value = z.state.spotShadow),
          (Ne.rectAreaLights.value = z.state.rectArea),
          (Ne.ltc_1.value = z.state.rectAreaLTC1),
          (Ne.ltc_2.value = z.state.rectAreaLTC2),
          (Ne.pointLights.value = z.state.point),
          (Ne.pointLightShadows.value = z.state.pointShadow),
          (Ne.hemisphereLights.value = z.state.hemi),
          (Ne.directionalShadowMap.value = z.state.directionalShadowMap),
          (Ne.directionalShadowMatrix.value = z.state.directionalShadowMatrix),
          (Ne.spotShadowMap.value = z.state.spotShadowMap),
          (Ne.spotLightMatrix.value = z.state.spotLightMatrix),
          (Ne.spotLightMap.value = z.state.spotLightMap),
          (Ne.pointShadowMap.value = z.state.pointShadowMap),
          (Ne.pointShadowMatrix.value = z.state.pointShadowMatrix));
      const Qe = Ae.getUniforms(),
        tt = Ar.seqWithValue(Qe.seq, Ne);
    ...
    function Kc(S, U, H, O, z) {
      ...
      const fe = U.fog,
        ...
        Ae = !!H.attributes.tangent && (!!O.normalMap || O.anisotropy > 0),
        Ne = !!H.morphAttributes.position,
        Qe = !!H.morphAttributes.normal,
        tt = !!H.morphAttributes.color;
      let Lt = Sn;
      O.toneMapped &&
      ...
      O.version === Ge.__version
        ? ((Ge.needsLights && Ge.lightsStateVersion !== Br.state.version) ||
          ...
          (rt = !0)
        : ((rt = !0), (Ge.__version = O.version));
      let Tn = Ge.currentProgram;
      rt === !0 && (Tn = Zi(O, U, z));
      let sa = !1,
        Ci = !1,
        Hr = !1;
      const Mt = Tn.getUniforms(),
        An = Ge.uniforms;
      if (
        (be.useProgram(Tn.program) && ((sa = !0), (Ci = !0), (Hr = !0)),
        O.id !== G && ((G = O.id), (Ci = !0)),
        sa || M !== S)
      ) {
      ...
      if (z.isSkinnedMesh) {
        Mt.setOptional(N, z, "bindMatrix"),
          Mt.setOptional(N, z, "bindMatrixInverse");
        const wt = z.skeleton;
        wt &&
      ...
      const zr = H.morphAttributes;
      if (
        ((zr.position !== void 0 ||
          zr.normal !== void 0 ||
          (zr.color !== void 0 && Pe.isWebGL2 === !0)) &&
          C.update(z, H, Tn),
        (Ci || Ge.receiveShadow !== z.receiveShadow) &&
          ((Ge.receiveShadow = z.receiveShadow),
          Mt.setValue(N, "receiveShadow", z.receiveShadow)),
        ...
        Ci &&
          (Mt.setValue(N, "toneMappingExposure", v.toneMappingExposure),
          Ge.needsLights && Zc(An, Hr),
          fe && O.fog === !0 && Q.refreshFogUniforms(An, fe),
          Q.refreshMaterialUniforms(An, O, V, q, ye),
          Ar.upload(N, Ge.uniformsList, An, De)),
        O.isShaderMaterial &&
          O.uniformsNeedUpdate === !0 &&
          (Ar.upload(N, Ge.uniformsList, An, De), (O.uniformsNeedUpdate = !1)),
        O.isSpriteMaterial && Mt.setValue(N, "center", z.center),
        Mt.setValue(N, "modelViewMatrix", z.modelViewMatrix),
        Mt.setValue(N, "normalMatrix", z.normalMatrix),
        Mt.setValue(N, "modelMatrix", z.matrixWorld),
        O.isShaderMaterial || O.isRawShaderMaterial)
      ) {
        const wt = O.uniformsGroups;
        for (let Gr = 0, Jc = wt.length; Gr < Jc; Gr++)
          if (Pe.isWebGL2) {
            const aa = wt[Gr];
            xe.update(aa, Tn), xe.bind(aa, Tn);
          } else
            console.warn(
    ...
    (this.getActiveCubeFace = function () {
      ...
      (this.setRenderTargetTextures = function (S, U, H) {
        (Fe.get(S.texture).__webglTexture = U),
          (Fe.get(S.depthTexture).__webglTexture = H);
        const O = Fe.get(S);
        (O.__hasExternalTextures = !0),
          O.__hasExternalTextures &&
            ((O.__autoAllocateDepthBuffer = H === void 0),
      ...
      (this.setRenderTarget = function (S, U = 0, H = 0) {
        (A = S), (b = U), (L = H);
        let O = !0,
          z = null,
          fe = !1,
        ...
        if (S) {
          ...
          S.isWebGLCubeRenderTarget
            ? (Array.isArray(Ae[U]) ? (z = Ae[U][H]) : (z = Ae[U]), (fe = !0))
            : Pe.isWebGL2 && S.samples > 0 && De.useMultisampledRTT(S) === !1
            ? (z = Fe.get(S).__webglMultisampledFramebuffer)
            : Array.isArray(Ae)
            ? (z = Ae[H])
            : (z = Ae),
            w.copy(S.viewport),
          ...
          w.copy(j).multiplyScalar(V).floor(),
            W.copy(I).multiplyScalar(V).floor(),
            (Z = B);
        if (
          (be.bindFramebuffer(N.FRAMEBUFFER, z) &&
            Pe.drawBuffers &&
            O &&
            be.drawBuffers(S, z),
          be.viewport(w),
      ...
      (this.readRenderTargetPixels = function (S, U, H, O, z, fe, Se) {
        ...
        if ((S.isWebGLCubeRenderTarget && Se !== void 0 && (we = we[Se]), we)) {
          ...
          try {
            ...
            U >= 0 &&
              ...
              H >= 0 &&
              H <= S.height - z &&
              N.readPixels(U, H, O, z, Ee.convert(ze), Ee.convert(Ae), fe);
          } finally {
            const Re = A !== null ? Fe.get(A).__webglFramebuffer : null;
            be.bindFramebuffer(N.FRAMEBUFFER, Re);
          }
        }
      }),
      (this.copyFramebufferToTexture = function (S, U, H = 0) {
        const O = Math.pow(2, -H),
          z = Math.floor(U.image.width * O),
          fe = Math.floor(U.image.height * O);
        De.setTexture2D(U, 0),
          N.copyTexSubImage2D(N.TEXTURE_2D, H, 0, 0, S.x, S.y, z, fe),
          be.unbindTexture();
      }),
      (this.copyTextureToTexture = function (S, U, H, O = 0) {
        const z = U.image.width,
          fe = U.image.height,
          Se = Ee.convert(H.format),
          we = Ee.convert(H.type);
        De.setTexture2D(H, 0),
          ...
          O === 0 && H.generateMipmaps && N.generateMipmap(N.TEXTURE_2D),
          be.unbindTexture();
      }),
      (this.copyTextureToTexture3D = function (S, U, H, O, z = 0) {
        ...
        const fe = S.max.x - S.min.x + 1,
          ...
          Re = Ee.convert(O.format),
          ze = Ee.convert(O.type);
        let Ae;
        ...
        const Ne = N.getParameter(N.UNPACK_ROW_LENGTH),
          ...
          Lt = N.getParameter(N.UNPACK_SKIP_ROWS),
          $t = N.getParameter(N.UNPACK_SKIP_IMAGES),
          it = H.isCompressedTexture ? H.mipmaps[0] : H.image;
        N.pixelStorei(N.UNPACK_ROW_LENGTH, it.width),
          ...
          H.isDataTexture || H.isData3DTexture
            ? N.texSubImage3D(Ae, z, U.x, U.y, U.z, fe, Se, we, Re, ze, it.data)
            ...
            : N.texSubImage3D(Ae, z, U.x, U.y, U.z, fe, Se, we, Re, ze, it),
          N.pixelStorei(N.UNPACK_ROW_LENGTH, Ne),
          N.pixelStorei(N.UNPACK_IMAGE_HEIGHT, Qe),
          N.pixelStorei(N.UNPACK_SKIP_PIXELS, tt),
          N.pixelStorei(N.UNPACK_SKIP_ROWS, Lt),
          N.pixelStorei(N.UNPACK_SKIP_IMAGES, $t),
          z === 0 && O.generateMipmaps && N.generateMipmap(Ae),
          be.unbindTexture();
      }),
      ...
      (this.resetState = function () {
        (b = 0), (L = 0), (A = null), be.reset(), _e.reset();
      }),
  ...
  set outputColorSpace(e) {
    ...
    (t.drawingBufferColorSpace = e === zs ? "display-p3" : "srgb"),
      (t.unpackColorSpace =
        Xe.workingColorSpace === Ir ? "display-p3" : "srgb");
  }
  ...
  get outputEncoding() {
    return (
      ...
      this.outputColorSpace === et ? Fn : gc
    );
  }
...
class _m extends Ot {
  ...
  raycast(e, t) {
    ...
    n !== void 0 &&
      ...
      e.ray.intersectsSphere(gs) !== !1 &&
        (Do.copy(i).invert(),
        _s.copy(e.ray).applyMatrix4(Do),
        !(
          this.boundingBox !== null && _s.intersectsBox(this.boundingBox) === !1
        ) && this._computeIntersections(e, t, _s)));
  }
  getVertexPosition(e, t) {
  ...
  applyBoneTransform(e, t) {
    const n = this.skeleton,
      i = this.geometry;
    Co.fromBufferAttribute(i.attributes.skinIndex, e),
      Lo.fromBufferAttribute(i.attributes.skinWeight, e),
      Ro.copy(t).applyMatrix4(this.bindMatrix),
      t.set(0, 0, 0);
    for (let s = 0; s < 4; s++) {
      const a = Lo.getComponent(s);
      if (a !== 0) {
        const o = Co.getComponent(s);
        Po.multiplyMatrices(n.bones[o].matrixWorld, n.boneInverses[o]),
          t.addScaledVector(gm.copy(Ro).applyMatrix4(Po), a);
      }
    }
...
class xm extends mt {
  constructor(e = null, t = 1, n = 1, i, s, a, o, c, l = dt, u = dt, h, d) {
...
class js {
  ...
  update() {
    ...
    for (let s = 0, a = e.length; s < a; s++) {
      ...
      Io.multiplyMatrices(o, t[s]), Io.toArray(n, s * 16);
    }
...
class Sm extends Ot {
  constructor(e, t, n) {
    super(e, t),
      ...
      (this.boundingBox = null),
      (this.boundingSphere = null);
    for (let i = 0; i < n; i++) this.setMatrixAt(i, Mm);
  }
  computeBoundingBox() {
    const e = this.geometry,
      t = this.count;
    ...
    for (let n = 0; n < t; n++)
      this.getMatrixAt(n, ci),
        Oo.copy(e.boundingBox).applyMatrix4(ci),
...
class Ks extends Je {
    ...
    if (e.index === null) {
      ...
      for (let i = 1, s = t.count; i < s; i++)
        Fo.fromBufferAttribute(t, i - 1),
          Bo.fromBufferAttribute(t, i),
          (n[i] = n[i - 1]),
          (n[i] += Fo.distanceTo(Bo));
  ...
  raycast(e, t) {
    ...
    if (
      ...
      return;
    Ho.copy(i).invert(), xs.copy(e.ray).applyMatrix4(Ho);
    ...
    if (g !== null) {
      const f = Math.max(0, a.start),
        T = Math.min(g.count, a.start + a.count);
      for (let v = f, y = T - 1; v < y; v += m) {
        const b = g.getX(v),
          L = g.getX(v + 1);
        if (
          (l.fromBufferAttribute(p, b),
          u.fromBufferAttribute(p, L),
          xs.distanceSqToSegment(l, u, d, h) > c)
        )
          continue;
      ...
      const f = Math.max(0, a.start),
        T = Math.min(p.count, a.start + a.count);
      for (let v = f, y = T - 1; v < y; v += m) {
        if (
  ...
  computeLineDistances() {
    ...
    if (e.index === null) {
      ...
      for (let i = 0, s = t.count; i < s; i += 2)
        zo.fromBufferAttribute(t, i),
          Go.fromBufferAttribute(t, i + 1),
          (n[i] = i === 0 ? 0 : n[i - 1]),
          (n[i + 1] = n[i] + zo.distanceTo(Go));
      e.setAttribute("lineDistance", new Gt(n, 1));
    } else
      console.warn(
...
class Em extends Je {
  ...
  raycast(e, t) {
    ...
    if (
      ...
      return;
    ko.copy(i).invert(), Us.copy(e.ray).applyMatrix4(ko);
    const o = s / ((this.scale.x + this.scale.y + this.scale.z) / 3),
      c = o * o,
      l = n.index,
    ...
    if (l !== null) {
      ...
      for (let g = d, _ = m; g < _; g++) {
        const p = l.getX(g);
        Sr.fromBufferAttribute(h, p), Vo(Sr, p, c, i, e, t, this);
      }
    } else {
      const d = Math.max(0, a.start),
        m = Math.min(h.count, a.start + a.count);
      for (let g = d, _ = m; g < _; g++)
        Sr.fromBufferAttribute(h, g), Vo(Sr, g, c, i, e, t, this);
    }
  }
  updateMorphTargets() {
    const t = this.geometry.morphAttributes,
...
function Vo(r, e, t, n, i, s, a) {
  const o = Us.distanceSqToPoint(r);
  if (o < t) {
    const c = new P();
    Us.closestPointToPoint(r, c), c.applyMatrix4(n);
...
class bm extends ji {
  ...
  interpolate_(e, t, n, i) {
    const s = this.resultBuffer,
      ...
      p = _ * g,
      f = -d * p + 2 * d * _ - d * g,
      T = (1 + d) * p + (-1.5 - 2 * d) * _ + (-0.5 + d) * g + 1,
      v = (-1 - m) * p + (1.5 + m) * _ + 0.5 * g,
      y = m * p - m * _;
    for (let b = 0; b !== o; ++b)
      s[b] = f * a[u + b] + T * a[l + b] + v * a[c + b] + y * a[h + b];
    return s;
  }
}
class wm extends ji {
...
Zt.prototype.DefaultInterpolation = xi;
class Ai extends Zt {}
...
class Cm extends ji {
  ...
  interpolate_(e, t, n, i) {
    const s = this.resultBuffer,
      ...
      c = (n - t) / (i - t);
    let l = e * o;
    for (let u = l + o; l !== u; l += 4) Yt.slerpFlat(s, 0, a, l - o, a, l, c);
    return s;
  }
}
class Gn extends Zt {
...
class Lm {
  ...
  static parse(e) {
    const t = [],
      n = e.tracks,
      i = 1 / (e.fps || 1);
    for (let a = 0, o = n.length; a !== o; ++a) t.push(Dm(n[a]).scale(i));
  ...
  static toJSON(e) {
    ...
    for (let s = 0, a = n.length; s !== a; ++s) t.push(Zt.toJSON(n[s]));
    return i;
  }
  ...
  static parseAnimation(e, t) {
    ...
    const n = function (h, d, m, g, _) {
        if (m.length !== 0) {
          const p = [],
            f = [];
          zc(m, p, f, g), p.length !== 0 && _.push(new h(d, p, f));
        }
      },
      i = [],
      s = e.name || "default",
        ...
        if (d[0].morphTargets) {
          ...
          for (const _ in m) {
            ...
            for (let T = 0; T !== d[g].morphTargets.length; ++T) {
              const v = d[g];
              p.push(v.time), f.push(v.morphTarget === _ ? 1 : 0);
            }
          ...
          n(yi, m + ".position", d, "pos", i),
            n(Gn, m + ".quaternion", d, "rot", i),
            n(yi, m + ".scale", d, "scl", i);
        }
    }
...
class $s {
  ...
  updateMatrices(e) {
    ...
    Xo.setFromMatrixPosition(e.matrixWorld),
      t.position.copy(Xo),
      qo.setFromMatrixPosition(e.target.matrixWorld),
      t.lookAt(qo),
      t.updateMatrixWorld(),
  ...
  load(e, t, n, i) {
    ...
    (o.credentials =
      ...
      fetch(e, o)
        ...
        .then(function (c) {
          Ei.add(e, c), t && t(c), s.manager.itemEnd(e);
        })
        .catch(function (c) {
...
const Js = "\\[\\]\\.:\\/",
  ...
  Qs = "[^" + Js + "]",
  qm = "[^" + Js.replace("\\.", "") + "]",
  jm = /((?:WC+[\/:])*)/.source.replace("WC", Qs),
  Ym = /(WCOD+)?/.source.replace("WCOD", qm),
  Km = /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC", Qs),
  Zm = /\.(WC+)(?:\[(.+)\])?/.source.replace("WC", Qs),
  $m = new RegExp("^" + jm + Ym + Km + Zm + "$"),
  Jm = ["material", "materials", "bones", "map"];
class Qm {
  constructor(e, t, n) {
...
class eg extends Bc {
  constructor(e = 1) {
    const t = [0, 0, 0, e, 0, 0, 0, 0, 0, 0, e, 0, 0, 0, 0, 0, 0, e],
      ...
      i = new kt();
    i.setAttribute("position", new Gt(t, 3)),
      i.setAttribute("color", new Gt(n, 3));
    const s = new Ys({ vertexColors: !0, toneMapped: !1 });
...
class ig {
  ...
  _loadLight(e) {
    ...
    switch (c.type) {
      case "directional":
        (l = new Vc(u)), l.target.position.set(0, 0, -1), l.add(l.target);
        break;
      case "point":
        (l = new Gm(u)), (l.distance = h);
        break;
      case "spot":
        (l = new Hm(u)),
          (l.distance = h),
  ...
  extendParams(e, t, n) {
    ...
    if (s) {
      ...
      s.baseColorTexture !== void 0 &&
        i.push(n.assignTexture(e, "map", s.baseColorTexture, et));
    }
  ...
  extendMaterialParams(e, t) {
    ...
    return (
      ...
      a.sheenColorTexture !== void 0 &&
        s.push(n.assignTexture(t, "sheenColorMap", a.sheenColorTexture, et)),
...
class ug {
  ...
  extendMaterialParams(e, t) {
    ...
    return (
      (t.attenuationColor = new Ie().setRGB(o[0], o[1], o[2], gt)),
      Promise.all(s)
    );
  }
}
...
class dg {
  ...
  extendMaterialParams(e, t) {
    ...
    return (
      (t.specularColor = new Ie().setRGB(o[0], o[1], o[2], gt)),
...
class xg {
  ...
  createNodeMesh(e) {
    ...
    for (const l of i.primitives)
      if (
        l.mode !== Dt.TRIANGLES &&
        l.mode !== Dt.TRIANGLE_STRIP &&
        l.mode !== Dt.TRIANGLE_FAN &&
        l.mode !== void 0
      )
        return null;
        ...
        Promise.all(o).then((l) => {
          ...
          for (const g of h) {
            const _ = new He(),
              ...
              f = new Yt(),
              T = new P(1, 1, 1),
              v = new Sm(g.geometry, g.material, d);
            for (let y = 0; y < d; y++)
              c.TRANSLATION && p.fromBufferAttribute(c.TRANSLATION, y),
                c.ROTATION && f.fromBufferAttribute(c.ROTATION, y),
                c.SCALE && T.fromBufferAttribute(c.SCALE, y),
                v.setMatrixAt(y, _.compose(p, f, T));
            for (const y in c)
              y !== "TRANSLATION" &&
                y !== "ROTATION" &&
                y !== "SCALE" &&
                g.geometry.setAttribute(y, c[y]);
            Je.prototype.copy.call(v, g),
...
const Wc = "glTF",
  Fi = 12,
  Zo = { JSON: 1313821514, BIN: 5130562 };
class vg {
  constructor(e) {
...
const Dt = {
  ...
  $o = { 9728: dt, 9729: At, 9984: Rs, 9985: cc, 9986: Tr, 9987: Bn },
  Jo = { 33071: It, 33648: br, 10497: gi },
  Ss = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4, MAT2: 4, MAT3: 9, MAT4: 16 },
  Os = {
    POSITION: "position",
    NORMAL: "normal",
    TANGENT: "tangent",
  ...
  Ag = { CUBICSPLINE: void 0, LINEAR: xi, STEP: Vi },
  ys = { OPAQUE: "OPAQUE", MASK: "MASK", BLEND: "BLEND" };
function bg(r) {
  return (
    r.DefaultMaterial === void 0 &&
      (r.DefaultMaterial = new Zs({
        color: 16777215,
        emissive: 0,
        metalness: 1,
        roughness: 1,
...
function Cg(r) {
  ...
  if (
    (t
      ? (e = "draco:" + t.bufferView + ":" + t.indices + ":" + Es(t.attributes))
      : (e = r.indices + ":" + Es(r.attributes) + ":" + r.mode),
    r.targets !== void 0)
  )
...
class Dg {
  constructor(e = {}, t = {}) {
    ...
    typeof navigator < "u" &&
      ...
      typeof createImageBitmap > "u" || n || (i && s < 98)
        ? (this.textureLoader = new Fm(this.options.manager))
        : (this.textureLoader = new Wm(this.options.manager)),
      this.textureLoader.setCrossOrigin(this.options.crossOrigin),
      this.textureLoader.setRequestHeader(this.options.requestHeader),
      (this.fileLoader = new kc(this.options.manager)),
  ...
  loadBuffer(e) {
    ...
    return new Promise(function (s, a) {
      n.load(Ns.resolveURL(t.uri, i.path), s, void 0, function () {
        a(
    ...
    return (
      ...
      Promise.all(s).then(function (a) {
        ...
        if (m && m !== h) {
          ...
          let v = t.cache.get(T);
          v ||
            ((_ = new l(o, f * m, (i.count * m) / u)),
            (v = new mm(_, m / u)),
            t.cache.add(T, v)),
            (p = new qs(v, c, (d % m) / u, g));
        } else o === null ? (_ = new l(i.count * c)) : (_ = new l(o, d, i.count * c)), (p = new Tt(_, c, g));
        if (i.sparse !== void 0) {
          const f = Ss.SCALAR,
            T = fi[i.sparse.indices.componentType],
            v = i.sparse.indices.byteOffset || 0,
            y = i.sparse.values.byteOffset || 0,
            b = new T(a[1], v, i.sparse.count * f),
            L = new l(a[2], y, i.sparse.count * c);
          o !== null && (p = new Tt(p.array.slice(), p.itemSize, p.normalized));
          for (let A = 0, G = b.length; A < G; A++) {
            const M = b[A];
            if (
              (p.setX(M, L[A * c]),
              c >= 2 && p.setY(M, L[A * c + 1]),
              c >= 3 && p.setZ(M, L[A * c + 2]),
              c >= 4 && p.setW(M, L[A * c + 3]),
              c >= 5)
            )
              throw new Error(
  ...
  loadTextureImage(e, t, n) {
    ...
    const l = this.loadImageSource(t, n)
      .then(function (u) {
        ...
        return (
          (u.magFilter = $o[d.magFilter] || At),
          (u.minFilter = $o[d.minFilter] || Bn),
      ...
      .then(function (h) {
        return new Promise(function (d, m) {
          ...
          t.isImageBitmapLoader === !0 &&
            ...
            t.load(Ns.resolveURL(h, s.path), g, void 0, m);
        });
      })
      .then(function (h) {
        return (
          l === !0 && o.revokeObjectURL(c),
          (h.userData.mimeType = a.mimeType || Lg(a.uri)),
          h
        );
      })
      .catch(function (h) {
  ...
  loadMaterial(e) {
    ...
    if (
      ...
      s.emissiveFactor !== void 0 && a !== In)
    ) {
      const h = s.emissiveFactor;
      o.emissive = new Ie().setRGB(h[0], h[1], h[2], gt);
    }
    return (
      s.emissiveTexture !== void 0 &&
        a !== In &&
        l.push(t.assignTexture(o, "emissiveMap", s.emissiveTexture, et)),
    ...
    return (
      ...
      Promise.all(o).then(function (c) {
        ...
        for (let m = 0, g = u.length; m < g; m++) {
          ...
          if (
            p.mode === Dt.TRIANGLES ||
            p.mode === Dt.TRIANGLE_STRIP ||
            p.mode === Dt.TRIANGLE_FAN ||
            p.mode === void 0
          )
            (f = s.isSkinnedMesh === !0 ? new _m(_, T) : new Ot(_, T)),
              f.isSkinnedMesh === !0 && f.normalizeSkinWeights(),
              p.mode === Dt.TRIANGLE_STRIP
                ? (f.geometry = Ko(f.geometry, mc))
                : p.mode === Dt.TRIANGLE_FAN &&
                  (f.geometry = Ko(f.geometry, Cs));
          else if (p.mode === Dt.LINES) f = new Bc(_, T);
          else if (p.mode === Dt.LINE_STRIP) f = new Ks(_, T);
          else if (p.mode === Dt.LINE_LOOP) f = new ym(_, T);
          else if (p.mode === Dt.POINTS) f = new Em(_, T);
          else
            throw new Error(
              "THREE.GLTFLoader: Primitive mode unsupported: " + p.mode
            );
          Object.keys(f.geometry.morphAttributes).length > 0 && Rg(f, s),
            (f.name = t.createUniqueName(s.name || "mesh_" + e)),
            xn(f, s),
            p.extensions && Ln(i, f, p),
            t.assignFinalMaterial(f),
            h.push(f);
        }
        for (let m = 0, g = h.length; m < g; m++)
          t.associations.set(h[m], { meshes: e, primitives: m });
        if (h.length === 1) return s.extensions && Ln(i, h[0], s), h[0];
        const d = new Un();
  ...
  loadCamera(e) {
    ...
    return (
      n.type === "perspective"
        ...
        : n.type === "orthographic" &&
          (t = new Ws(-i.xmag, i.xmag, i.ymag, -i.ymag, i.znear, i.zfar)),
  ...
  loadAnimation(e) {
    ...
    return Promise.all([
      ...
      for (let T = 0, v = d.length; T < v; T++) {
        ...
        const M = n._createAnimationTracks(y, b, L, A, G);
        if (M) for (let w = 0; w < M.length; w++) f.push(M[w]);
      }
      return new Lm(s, void 0, f);
    });
  }
  createNodeMesh(e) {
    const t = this.json,
    ...
    return Promise.all(o).then(function (c) {
      ...
      const l = (u) => {
        ...
        for (const [d, m] of i.associations)
          (d instanceof jt || d instanceof mt) && h.set(d, m);
        return (
          u.traverse((d) => {
  ...
  _createAnimationTracks(e, t, n, i, s) {
    ...
    const u = i.interpolation !== void 0 ? Ag[i.interpolation] : xi,
      h = this._getArrayFromAccessor(n);
    for (let d = 0, m = c.length; d < m; d++) {
      const g = new l(c[d] + "." + gn[s.path], t.array, h, u);
  ...
  _createCubicSplineTrackInterpolant(e) {
    (e.createInterpolant = function (n) {
      const i = this instanceof Gn ? Tg : Xc;
...
function Qo(r, e, t) {
  ...
  return (
    ...
    Promise.all(i).then(function () {
      return e.targets !== void 0 ? wg(r, e.targets, t) : r;
    })
  );
}
  ...
  constructor(e, t) {
    super(),
      ...
      (this.update = (function () {
        const C = new P(),
          te = new Yt().setFromUnitVectors(e.up, new P(0, 1, 0)),
          X = te.clone().invert(),
          Ee = new P(),
          _e = new Yt(),
          xe = new P(),
        ...
        return function (se = null) {
          ...
          if (n.zoomToCursor && L) {
            ...
            if (n.object.isPerspectiveCamera) {
              ...
              pe = K(Te * l);
              const nt = Te - pe;
              n.object.position.addScaledVector(y, nt),
                n.object.updateMatrixWorld();
            } else if (n.object.isOrthographicCamera) {
              const Te = new P(b.x, b.y, 0);
            ...
            pe !== null &&
              (this.screenSpacePanning
                ...
                : (Er.origin.copy(n.object.position),
                  Er.direction
                    .set(0, 0, -1)
                    .transformDirection(n.object.matrix),
                  Math.abs(n.object.up.dot(Er.direction)) < Ug
                    ? e.lookAt(n.target)
                    : (nc.setFromNormalAndCoplanarPoint(n.object.up, n.target),
                      Er.intersectPlane(nc, n.target))));
          } else
          ...
          return (
            ...
            (L = !1),
            Y ||
            Ee.distanceToSquared(n.object.position) > a ||
    ...
    const J = (function () {
        ...
        return function (X, Ee) {
          C.setFromMatrixColumn(Ee, 0), C.multiplyScalar(-X), u.add(C);
        };
      })(),
      D = (function () {
        const C = new P();
        return function (X, Ee) {
          n.screenSpacePanning === !0
            ? C.setFromMatrixColumn(Ee, 1)
            : (C.setFromMatrixColumn(Ee, 0), C.crossVectors(n.object.up, C)),
            C.multiplyScalar(X),
            u.add(C);
        };
      })(),
        ...
        return function (X, Ee) {
          ...
          if (n.object.isPerspectiveCamera) {
            ...
            (me *= Math.tan(((n.object.fov / 2) * Math.PI) / 180)),
              J((2 * X * me) / _e.clientHeight, n.object.matrix),
              D((2 * Ee * me) / _e.clientHeight, n.object.matrix);
          } else
            n.object.isOrthographicCamera
              ? (J(
    ...
    function I(C) {
      ie(C), f.set(C.clientX, C.clientY);
    }
    function B(C) {
    ...
    function ye(C) {
      ie(C), C.deltaY < 0 ? V(w()) : C.deltaY > 0 && q(w()), n.update();
    }
    function Le(C) {
      let te = !1;
      switch (C.code) {
    ...
    function ve() {
      if (A.length === 1) h.set(A[0].pageX, A[0].pageY);
        ...
        const C = 0.5 * (A[0].pageX + A[1].pageX),
          te = 0.5 * (A[0].pageY + A[1].pageY);
        h.set(C, te);
      }
    }
    function Ve() {
      if (A.length === 1) g.set(A[0].pageX, A[0].pageY);
      else {
        const C = 0.5 * (A[0].pageX + A[1].pageX),
          te = 0.5 * (A[0].pageY + A[1].pageY);
        g.set(C, te);
    ...
    function ft() {
      const C = A[0].pageX - A[1].pageX,
        te = A[0].pageY - A[1].pageY,
    ...
    function at(C) {
      if (A.length == 1) d.set(C.pageX, C.pageY);
      else {
        const X = ue(C),
          Ee = 0.5 * (C.pageX + X.x),
          _e = 0.5 * (C.pageY + X.y);
    ...
    function Me(C) {
      if (A.length === 1) _.set(C.pageX, C.pageY);
      else {
        const te = ue(C),
          X = 0.5 * (C.pageX + te.x),
          Ee = 0.5 * (C.pageY + te.y);
      ...
      p.subVectors(_, g).multiplyScalar(n.panSpeed), k(p.x, p.y), g.copy(_);
    }
    function Pe(C) {
      const te = ue(C),
        X = C.pageX - te.x,
        Ee = C.pageY - te.y,
        _e = Math.sqrt(X * X + Ee * Ee);
      T.set(0, _e),
        v.set(0, Math.pow(T.y / f.y, n.zoomSpeed)),
        q(v.y),
        f.copy(T);
    }
    function be(C) {
    ...
    function E(C) {
      n.enabled === !1 ||
        n.enableZoom === !1 ||
        s !== i.NONE ||
        (C.preventDefault(), n.dispatchEvent(Ts), ye(C), n.dispatchEvent(tc));
    }
    function x(C) {
      n.enabled === !1 || n.enablePan === !1 || Le(C);
    }
    function F(C) {
      switch ((re(C), A.length)) {
        case 1:
    ...
    function ge(C) {
      ...
      for (let te = 0; te < A.length; te++)
        if (A[te].pointerId == C.pointerId) {
          A.splice(te, 1);
          return;
        }
    }
    function re(C) {
      let te = G[C.pointerId];
      te === void 0 && ((te = new Ce()), (G[C.pointerId] = te)),
        te.set(C.pageX, C.pageY);
    }
    function ue(C) {
      const te = C.pointerId === A[0].pointerId ? A[1] : A[0];
      return G[te.pointerId];
    }
...
const Ri = new pm();
Ri.background = new Ie("lightgray");
const Og = new eg(5);
Ri.add(Og);
const Yi = new Et(60, window.innerWidth / window.innerHeight, 0.1, 1e3);
Yi.position.set(5, 10, 10);
Yi.lookAt(0, 0, 0);
Yi.rotation.x = -Math.PI / 4;
const Fr = new Oc();
Fr.setSize(window.innerWidth, window.innerHeight);
document.body.appendChild(Fr.domElement);
const Fg = new Vm(4210752, 8);
Ri.add(Fg);
const qc = new Vc(16777215, 2);
qc.position.set(1, 1, 1);
Ri.add(qc);
const Bg = new tg();
Bg.load(
...
const ea = new Ng(Yi, Fr.domElement);
ea.enableZoom = !0;
ea.enablePan = !0;
ea.update();
function jc() {
  requestAnimationFrame(jc), Fr.render(Ri, Yi);
}
jc();
